...
function sendValue(id,nama) {
	...
	self.parent.document.getElementById('op_dokter_nama_<?php echo $_GET["el"];?>').value = nama;
	self.parent.document.getElementById('id_dokter_<?php echo $_GET["el"];?>').value = id;
