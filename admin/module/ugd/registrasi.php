<?php
	...
	$dtaccess = new DataAccess();
     ...
     function GetRawatinap($status) {
          ...
          $sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu, a.reg_jadwal
				...
				where reg_ugd = 'y' order by reg_status desc, reg_tanggal asc, reg_waktu asc";
          //echo $sql;
	...
	if($_GET["id_reg"] ) {
		...
		$sql = "select * from klinik.klinik_ugd
                    where id_reg = ".QuoteValue(DPE_CHAR,$_GET["id_reg"]);
          $data= $dtaccess->Fetch($sql);
          
		$_POST["ugd_keterangan"] = $data["ugd_keterangan"];
	}
	...
	if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
          ...
          $dbField[0] = "ugd_id";   // PK
          $dbField[1] = "id_reg";
          $dbField[2] = "ugd_tanggal_masuk";
          $dbField[3] = "ugd_waktu_masuk";
          $dbField[4] = "ugd_keterangan";
          
          if(!$_POST["ugd_id"]) $ugd_id = $dtaccess->GetTransID("klinik_ugd","ugd_id",DB_SCHEMA_KLINIK);
          
          $dbValue[0] = QuoteValue(DPE_CHAR,$ugd_id);   // PK
          $dbValue[1] = QuoteValue(DPE_CHAR,$_POST["id_reg"]);
          $dbValue[2] = QuoteValue(DPE_DATE,date("Y-m-d"));
          $dbValue[3] = QuoteValue(DPE_DATE,date("H:i:s"));
          $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["ugd_keterangan"]);
...
//          $sqlUpdate = "update klinik_registrasi set reg_status='".STATUS_RAWATINAP.STATUS_MENGINAP."' where reg_id = ".QuoteValue(DPE_CHAR,$_POST["id_reg"]);
//          $dtaccess->Execute($sqlUpdate,DB_SCHEMA_KLINIK);
...
<div id="antri_main" style="width:100%;height:auto;clear:both;overflow:auto">
	...
	<div id="antri_kanan" style="float:left;width:49%;">
		<div class="tableheader">Proses Registrasi UGD</div>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" colspan=2 class="tableheader">Input Data UGD</td>
	</tr>
</table> 
...
<tr>
     ...
     <fieldset>
     <legend><strong>Registrasi UGD</strong></legend>
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
        <tr>
          <td class="tablecontent"  width="20%"> Keluhan</td>
          <td class="tablecontent-odd"><?php echo $view->RenderTextArea("ugd_keterangan","ugd_keterangan","7","100",$_POST["ugd_keterangan"],"inputField", null,false);?>
        </tr>
        <!--<tr >
