...
<tr>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_ekg","diag_ekg","15","15",$_POST["diag_ekg"],"inputField", null,false);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Fundus Angiografi</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_fundus","diag_fundus","15","15",$_POST["diag_fundus"],"inputField", null,false);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Indirect Opthalmoscopy</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_opthalmoscop","diag_opthalmoscop","15","50",$_POST["diag_opthalmoscop"],"inputField", null,null);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Optical Coherence Tomographi</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_oct","diag_oct","15","50",$_POST["diag_oct"],"inputField", null,null);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Yag Laser</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_yag","diag_yag","15","50",$_POST["diag_yag"],"inputField", null,null);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Argon Laser</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_argon","diag_argon","15","50",$_POST["diag_argon"],"inputField", null,null);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Laser Glaukoma</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_glaukoma","diag_glaukoma","15","50",$_POST["diag_glaukoma"],"inputField", null,null);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">Humprey</td>
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("diag_humpre","diag_humpre","15","50",$_POST["diag_humpre"],"inputField", null,null);?></td>
          </tr>
	</table>
     </fieldset>
