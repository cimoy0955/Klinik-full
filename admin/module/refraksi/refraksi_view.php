<?php
	...
	$tree = new CTree("global.global_customer","cust_id",TREE_LENGTH);
     ...
     $_x_mode = "New";
     $thisPage = "refraksi_view.php";
     $editPage = "refraksi.php?";
	...
	if($_POST["cust_usr_id"]) {
     ...
     if($dataPasien) {
          ...
          $sql = "select a.ref_id, a.ref_tanggal from klinik.klinik_refraksi a where a.id_cust_usr = ".QuoteValue(DPE_NUMERIC,$_POST["cust_usr_id"])." 
                    order by a.ref_tanggal desc";
          ...
          $isAllowedUpdate = $auth->IsAllowed("refraksi",PRIV_UPDATE);
          ...
          for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
               ...
               if($isAllowedUpdate) {
                    $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&id='.$enc->Encode($dataTable[$i]["ref_id"]).'"><img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/b_edit.png" alt="Edit" title="Edit" border="0"></a>';               
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" colspan=2 class="tableheader">Data Refraksi</td>
	</tr>
</table> 
