...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('icd_id_<?php echo $_GET["el"];?>').value = id;		
	self.parent.document.getElementById('icd_nomor_<?php echo $_GET["el"];?>').value = kode;
	self.parent.document.getElementById('icd_nama_<?php echo $_GET["el"];?>').value = nama;
