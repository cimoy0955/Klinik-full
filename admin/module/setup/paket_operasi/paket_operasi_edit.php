<?php
	...
	if($_POST["op_paket_id"])  $opPaketId = & $_POST["op_paket_id"];
     ...
     if ($_GET["id"]) {
          ...
          $_POST["op_paket_total"] = $row_edit["op_paket_total"];
	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {          
          ...
          if ($err_code == 0) {
               ...
               $dbValue[2] = QuoteValue(DPE_NUMERIC,StripCurrency($_POST["op_paket_total"]));
...
function setPaketTotal() {
     document.getElementById('op_paket_total').value = formatCurrency((stripCurrency(document.getElementById('txtNom_1').value) * 1) + (stripCurrency(document.getElementById('txtNom_2').value) * 1));
}
</script>
			...
			<td>
				<table width="100%" border="1" cellpadding="1" cellspacing="1">
					<tr>
						...
						<?php } ?>
                                   <td class="subheader" align="center">Total</td>
					</tr> 
					<tr>
						<?php for($j=0,$k=count($dataSplit);$j<$k;$j++){ ?>
							<td align="center">
						...
						<?php } ?>
                              <td align="center">
                                <?php echo $view->RenderTextBox("op_paket_total","op_paket_total","10","10",currency_format($_POST["op_paket_total"]),"curedit", null,true,"onfocus=\"setPaketTotal()\";");?>
                              </td>
					</tr>
				</table>
			</td>
