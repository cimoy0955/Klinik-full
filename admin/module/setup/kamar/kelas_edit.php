     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {          
          ...
          if ($err_code == 0) {
			...
			$dtaccess->Execute($sql);
               ...
               header("location:kelas_view.php");
               exit();        
          }
     }
...
<tr>
     <td>
     <fieldset>
     <legend><strong>Setup Kelas</strong></legend>
     <table width="100%" border="1" cellpadding="1" cellspacing="1">
          <tr>
          ...
          <td align="right" width="10%">&nbsp;Biaya</td>
              <td width="35%">
                  <select name="biaya_jenis">
    				...
    				<?php foreach($namaKelas as $key=>$value) {?>
...
<?php echo $view->RenderHidden("biaya_id","biaya_id",$opPaketId);?>
<? } ?>
