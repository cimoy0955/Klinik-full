<?php
	...
	$sql = "select reg_id, reg_jenis_pasien, reg_rujukan  
			...
			where a.id_cust_usr = ".QuoteValue(DPE_NUMERIC,$_POST["cust_usr_id"])." and reg_tanggal <> ".QuoteValue(DPE_DATE,date('Y-m-d'))." 
...
<table width="610" border="1" cellpadding="2" cellspacing="0" class="tableisi">
  ...
  <tr>
    <td width="70">NAMA</td>
    <td width="181" style="font-size:16pt;font-weight:bold">&nbsp;<?php echo $dataPasien["cust_usr_nama"]; ?></td>
    <td width="55">NO REG</td>
    <td width="143" style="font-size:16pt;font-weight:bold">&nbsp;<?php echo $dataPasien["cust_usr_kode"]; ?></td>
  </tr>
  <tr>
    <td>UMUR</td>
...
<table width="610" border="1" cellpadding="2" cellspacing="0" class="tableisi"> 
  <tr>
    ...
    <td width="237" colspan="3" bgcolor="#CCCCCC" align="center">VISUAL ACUITY OS</td> 
  </tr>
  <tr>
...
<table width="610" border="1" cellpadding="2" cellspacing="0" class="tableisi">
  <tr height="40" valign=top>
	<td colspan="2" width="237" align="justify"><u>PEMERIKSAAN LAB</u>
  ...
  <tr>
	...
	<td width="150" bgcolor="#CCCCCC">DIAGNOSIS OS</td>
	<td width="50" bgcolor="#CCCCCC">ICD 10</td>
  </tr> 
  <tr>
