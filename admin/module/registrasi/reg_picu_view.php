<?php
     ...
     $editPage = "reg_picu_edit.php";
     $thisPage = "reg_picu_view.php";
	...
	$sql = "select a.reg_status, a.reg_id, b.cust_usr_kode, cust_usr_nama, id_cust_usr 
			...
			where reg_status not like '".STATUS_SELESAI."%' and reg_status not like '".STATUS_MENINGGAL."%' 
      and reg_status not like '".STATUS_PICU."%'
