...
function sendValue(nama,id,harga) {
	self.parent.document.getElementById('obat_nama_1').value = nama;
	self.parent.document.getElementById('obat_id_1').value = id;
	self.parent.document.getElementById('txtHargaSatuan_1').value = formatCurrency(harga);
	self.parent.document.getElementById('txtHargaTotal_1').value = formatCurrency(harga);
	self.parent.document.getElementById('txtJumlah_1').value = '1';
	self.parent.document.getElementById('txtJumlah_1').focus();
