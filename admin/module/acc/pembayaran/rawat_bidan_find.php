...
function GetData($in_nama){
	...
	$sql_where[] = "pgw_jenis_pegawai = ".PGW_JENIS_BIDAN; 
...
function sendValue(id,nama) {
	...
	self.parent.document.getElementById('rawat_bidan_nama').value = nama;
	self.parent.document.getElementById('id_bidan').value = id;
