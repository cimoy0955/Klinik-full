...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('rawat_ina_kode_<?php echo $_GET["el"];?>').value = kode;
	self.parent.document.getElementById('rawat_ina_nama_<?php echo $_GET["el"];?>').value = nama;
	self.parent.document.getElementById('rawat_ina_id_<?php echo $_GET["el"];?>').value = id;
...
<tr>
	<td>
		<table cellpadding="1" cellspacing="1" border="1" align="center" width="100%">
			...
			<tr>
				<td align="right" class="tablecontent" width="30%">INA GRD</td>
