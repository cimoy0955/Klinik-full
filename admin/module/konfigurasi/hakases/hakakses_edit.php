    ...
    // }
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
          ...
          if ($err_code == 0) {
               ...
               $dbValue[1] = QuoteValue(DPE_CHAR,strtoupper($_POST["usr_loginname"]));
               $dbValue[2] = QuoteValue(DPE_CHAR,strtoupper($_POST["usr_name"]));
               ...
               if($_POST["is_password"]) $dbValue[6] = QuoteValue(DPE_CHAR,md5(strtoupper($_POST["usr_password"])));
