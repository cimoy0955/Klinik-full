<?php
     ...
     $backPage = "role_act_view.php?id=".$enc->Encode($_POST["id_rol"]);
...
<script language="JavaScript" type="text/javascript" src="<?php echo $APLICATION_ROOT;?>lib/script/func_curr.js"></script>
