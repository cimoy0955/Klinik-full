<?php
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
          ...
          if ($err_code == 0) {
               ...
               $dbField[7] = "usr_poli";       
               if($_POST["is_password"]) $dbField[8] = "usr_password";
               ...
               $dbValue[7] = QuoteValue(DPE_NUMERIC,$_POST["usr_poli"]);
               if($_POST["is_password"]) $dbValue[8] = QuoteValue(DPE_CHAR,md5($_POST["usr_password"]));
          ...
          <td>
               ...
               <table width="100%" border="1" cellpadding="1" cellspacing="1">               
                    <tr>
                    	...
                    	<tr>
		                   <td class="tablecontent" width="30%" align="right" class="tblMainCol">Nama Poli</td>
                            <td width="70%" class="tblCol">
                  			<select name="usr_poli" id="usr_poli" onKeyDown="return tabOnEnter(this, event);">
                                      <option value="--">[ Pilih Poli ]</option>
                  				<?php for($i=0,$n=count($dataPoli);$i<$n;$i++){ ?>								
                  					<option value="<?php echo $dataPoli[$i]["poli_id"];?>" <?php if($dataPoli[$i]["poli_id"]==$_POST["usr_poli"]) echo "selected"; ?>><?php echo $dataPoli[$i]["poli_nama"];?></option>
                  				<?php } ?>
                  			</select>
                  		</td>
	                 </tr>
