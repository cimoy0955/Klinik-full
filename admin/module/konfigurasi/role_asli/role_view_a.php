<?php
     ...
     $cok = $auth->IsAllowed("setup_role",PRIV_READ);
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          ...
          if($auth->IsAllowed("setup_role",PRIV_READ)) {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$detPage.'?id='.$dataTable[$i]["rol_id"].'&app_id='.$dataTable[$i]["id_app"].'"><img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/b_select.png" alt="Detail" title="Detail" border="0"></a>';
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
               $counter++;
          }
