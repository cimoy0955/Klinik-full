<?php
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          ...
          if($dataTable[$i]["rol_id"]!=0 && $dataTable[$i]["rol_id"]!=ROLE_TIPE_CUSTOMER)
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'?id='.$dataTable[$i]["rol_id"].'"><img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/b_edit.png" alt="Edit" title="Edit" border="0"></a>';
          else
               $tbContent[$i][$counter][TABLE_ISI] = '';
          $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          $counter++;
          
          $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$detPage.'?id='.$dataTable[$i]["rol_id"].'"><img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/b_select.png" alt="Detail" title="Detail" border="0"></a>';
          $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          $counter++;
