<?php
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
		if($_POST["btnUpdate"]){
          ...
          if ($err_code == 0) {
               ...
               $dbValue[2] = QuoteValue(DPE_NUMERIC,$_POST["app_id"]);
    ...
    // -- cari daftar app -- //
    $rs = $dtaccess->Execute("select * from global_app");
    while($dataApp = $dtaccess->Fetch($rs)){
      $optApp[] = $view->RenderOption($dataApp["app_id"],$dataApp["app_nama"],($dataApp["app_id"]==$_POST["app_id"])?"selected":"");
    }
...
<tr>
    ...
    <legend><strong>User Role Config</strong></legend>
			<table width="100%" border="1" cellpadding="1" cellspacing="1">
			   <tr>
			        <td class="tablecontent" width="30%" align="right" class="tblMainCol"><strong>Default Application&nbsp;</strong></td>
			        <td width="70%"><?php echo $view->RenderComboBox("app_id","app_id",$optApp);?></td>
			   </tr>
			   <tr>
