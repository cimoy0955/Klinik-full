   ...
   if($_GET["panel"]) $panel = $_GET["panel"];
	...
	switch($panel){   
		...
		case "dokter":
			...
			$menu[$countMenu]["priv"] = "refraksi";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/refraksi/edit_pasien_view.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
    ...
    // --- menu rawat inap ---
		...
		case "report":
			...
			$menu[$countMenu]["head"] = "Report Pasien Refraksi";
			$menu[$countMenu]["priv"] = "report_refraksi";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/refraksi/report_pasien_refraksi.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
			...
			$menu[$countMenu]["head"] = "Report Refraksionis";
			$menu[$countMenu]["priv"] = "report_refraksi";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/refraksi/report_refraksionist.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
			
			$menu[$countMenu]["head"] = "Report Biaya Refraksi";
			$menu[$countMenu]["priv"] = "report_refraksi";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/refraksi/report_biaya.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
