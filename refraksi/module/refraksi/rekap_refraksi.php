<?php
     ...
     $sql_where_nonkoreksi = "(a.id_visus_nonkoreksi_od is not null or a.id_visus_nonkoreksi_os is not null)";
     $sql_where_koreksi_null = "(a.id_visus_koreksi_od is null or a.id_visus_koreksi_os is null)";
     $sql_where_koreksi_notnull = "(a.id_visus_koreksi_od is not null or a.id_visus_koreksi_os is not null)";
     ...
     /*
      *  jumlah refraksi dengan visus non koreksi
      */
     $sql_visus_nonkoreksi = $sqlBaru." and ".$sql_where_nonkoreksi." and ".$sql_where_koreksi_null;
     $rs_visus_nonkoreksi = $dtaccess->Execute($sql_visus_nonkoreksi);
     $data_visus_nonkoreksi = $dtaccess->Fetch($rs_visus_nonkoreksi);
     /* end of visus non koreksi */
      
     /*
      *  jumlah refraksi dengan visus non koreksi
      */
     $sql_visus_koreksi = $sqlBaru." and ".$sql_where_nonkoreksi." and ".$sql_where_koreksi_notnull;
     $rs_visus_koreksi = $dtaccess->Execute($sql_visus_koreksi);
     $data_visus_koreksi = $dtaccess->Fetch($rs_visus_koreksi);
     
     /* end of visus koreksi */
...
<BR>
     ...
     <table width="50%" border="1" cellpadding="1" cellspacing="1">
          ...
          <tr>
               <td class="tablecontent" width="50%" align="leftleft">Pasien Visus Saja</td>
               <td width="50%" class="tablecontent-odd"  align="center"><?php echo $data_visus_nonkoreksi["total"];?></td>	     
          </tr>
          <tr>
               <td class="tablecontent" width="50%" align="leftleft">Pasien Visus dg Koreksi</td>
               <td width="50%" class="tablecontent-odd"  align="center"><?php echo $data_visus_koreksi["total"];?></td>	     
          </tr>
          <tr>
