...
$sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu, a.reg_jadwal, z.fol_lunas ,a.reg_jenis_pasien
	  ...
	  left join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id
		      left join (
			      ...
			      where (fol_jenis = '".STATUS_PEMERIKSAAN."' or fol_jenis = '".STATUS_REGISTRASI."' )
		      ) z on a.reg_id = z.id_reg 
	  where a.reg_status like '".STATUS_PEMERIKSAAN.$status."' and a.reg_tipe_umur = 'A'
...
for($i=0,$n=count($dataTable),$counter=0;$i<$n;$i++,$counter=0) {
     if($status==0) {
	     /*if($dataTable[$i]["fol_lunas"]=="y")*/ $tbContent[$i][$counter][TABLE_ISI] = '<img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/bul_arrowgrnlrg.gif" style="cursor:pointer" alt="Proses" title="Proses" border="0" onClick="ProsesPerawatan(\''.$dataTable[$i]["reg_id"].'\')"/>';
     } else {
     ...
     $counter++;
	      ...
	      if($status==0) {
		      if($dataTable[$i]["fol_lunas"]=="y") $tbContent[$i][$counter][TABLE_ISI] = '<img hspace="2" width="16" height="16" src="'.$APLICATION_ROOT.'images/on.gif" style="cursor:pointer" alt="Lunas" title="Lunas" border="0"/>';
...
$_POST["ref_nama_ortu"] = $dataPasien["cust_usr_ortu"];
$_POST["ref_no_telp"] = $dataPasien["cust_usr_telp"];
...
$sql = "select icd_nama,icd_nomor, icd_id from klinik.klinik_perawatan_icd a
     ...
     where id_rawat = ".QuoteValue(DPE_CHAR,$_POST["rawat_id"])." and rawat_icd_odos = 'OD'
...
$sql = "select icd_nama,icd_nomor, icd_id from klinik.klinik_perawatan_icd a
     join klinik.klinik_icd b on a.id_icd = b.icd_nomor
     where id_rawat = ".QuoteValue(DPE_CHAR,$_POST["rawat_id"])." and rawat_icd_odos = 'OS'
     order by rawat_icd_urut";
$rs = $dtaccess->Execute($sql);
$i=0;
...
$sql = "select ina_nama,ina_kode, ina_id from klinik.klinik_perawatan_ina a
     ...
     where id_rawat = ".QuoteValue(DPE_CHAR,$_POST["rawat_id"])." and rawat_ina_odos = 'OD'
...
$sql = "select ina_nama,ina_kode, ina_id from klinik.klinik_perawatan_ina a
     join klinik.klinik_ina b on a.id_ina = b.ina_id
     where id_rawat = ".QuoteValue(DPE_CHAR,$_POST["rawat_id"])." and rawat_ina_odos = 'OS'
     order by rawat_ina_urut";
$rs = $dtaccess->Execute($sql);
$i=0;
...
$sql_update = "update global.global_customer_user
	       set cust_usr_ortu=".QuoteValue(DPE_CHAR,$_POST["ref_nama_ortu"]).",
	       cust_usr_telp=".QuoteValue(DPE_CHAR,$_POST["ref_no_telp"])."
	       where cust_usr_id=".QuoteValue(DPE_NUMERIC,$_POST["id_cust_usr"]);
$rs_update = $dtaccess->Execute($sql_update);

//---- insert ke tabel poli_anak.poli_anak_pemeriksaan ----//
$dbTable = "poli_anak.poli_anak_pemeriksaan";
$dbField[0] = "rawat_id";
$dbField[1] = "id_reg";
$dbField[2] = "rawat_asal_rujukan";
$dbField[3] = "rawat_anamnesa";
$dbField[4] = "rawat_diag_sementara";
$dbField[5] = "rawat_terapi_sementara";
$dbField[6] = "rawat_create";

if(!$_POST["rawat_id"]) $_POST["rawat_id"] = $dtaccess->GetTransID();
$dbValue[0] = QuoteValue(DPE_CHAR,$_POST["rawat_id"]);   // PK
$dbValue[1] = QuoteValue(DPE_CHAR,$_POST["id_reg"]);
$dbValue[2] = QuoteValue(DPE_CHAR,$_POST["reg_asal_rujukan"]);
$dbValue[3] = QuoteValue(DPE_CHAR,$_POST["reg_anamnesa"]);
$dbValue[4] = QuoteValue(DPE_CHAR,$_POST["reg_diag_sementara"]);
$dbValue[5] = QuoteValue(DPE_CHAR,$_POST["reg_terapi_sementara"]);
...
$dbField[11] = "ref_ark_koreksi_spheris_od";
$dbField[12] = "ref_ark_koreksi_cylinder_od";
$dbField[13] = "ref_ark_koreksi_sudut_od";
$dbField[14] = "ref_ark_koreksi_spheris_os";
$dbField[15] = "ref_ark_koreksi_cylinder_os";
$dbField[16] = "ref_ark_koreksi_sudut_os";
$dbField[17] = "ref_lenso_koreksi_spheris_od";
$dbField[18] = "ref_lenso_koreksi_cylinder_od";
$dbField[19] = "ref_lenso_koreksi_sudut_od";
$dbField[20] = "ref_lenso_koreksi_spheris_os";
$dbField[21] = "ref_lenso_koreksi_cylinder_os";
$dbField[22] = "ref_lenso_koreksi_sudut_os";
$dbField[23] = "ref_streak_koreksi_spheris_od";
$dbField[24] = "ref_streak_koreksi_cylinder_od";
$dbField[25] = "ref_streak_koreksi_sudut_od";
$dbField[26] = "ref_streak_koreksi_spheris_os";
$dbField[27] = "ref_streak_koreksi_cylinder_os";
$dbField[28] = "ref_streak_koreksi_sudut_os";
$dbField[29] = "ref_subj_tnp_myr_spheris_od";
$dbField[30] = "ref_subj_tnp_myr_cylinder_od"; 
$dbField[31] = "ref_subj_tnp_myr_sudut_od"; 
$dbField[32] = "ref_subj_tnp_myr_spheris_os";
$dbField[33] = "ref_subj_tnp_myr_cylinder_os"; 
$dbField[34] = "ref_subj_tnp_myr_sudut_os ";
$dbField[35] = "ref_subj_dgn_myr_spheris_od"; 
$dbField[36] = "ref_subj_dgn_myr_cylinder_od"; 
$dbField[37] = "ref_subj_dgn_myr_sudut_od"; 
$dbField[38] = "ref_subj_dgn_myr_spheris_os"; 
$dbField[39] = "ref_subj_dgn_myr_cylinder_os"; 
$dbField[40] = "ref_subj_dgn_myr_sudut_os"; 
$dbField[41] = "id_visus_subj_tnp_myr_od"; 
$dbField[42] = "id_visus_subj_tnp_myr_os"; 
$dbField[43] = "id_visus_subj_dgn_myr_od"; 
$dbField[44] = "id_visus_subj_dgn_myr_os"; 
$dbField[45] = "id_visus_streak_od"; 
$dbField[46] = "id_visus_streak_os";
...
$dbValue[11] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_ark_spheris"]);
$dbValue[12] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_ark_cylinder"]);
$dbValue[13] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_ark_sudut"]);
$dbValue[14] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_ark_spheris"]);
$dbValue[15] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_ark_cylinder"]);
$dbValue[16] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_ark_sudut"]);
$dbValue[17] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_lensometer_spheris"]);
$dbValue[18] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_lensometer_cylinder"]);
$dbValue[19] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_lensometer_sudut"]);
$dbValue[20] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_lensometer_spheris"]);
$dbValue[21] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_lensometer_cylinder"]);
$dbValue[22] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_lensometer_sudut"]);
$dbValue[23] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_retinoscopy_spheris"]);
$dbValue[24] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_retinoscopy_cylinder"]);
$dbValue[25] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_retinoscopy_sudut"]);
$dbValue[26] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_retinoscopy_spheris"]);
$dbValue[27] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_retinoscopy_cylinder"]);
$dbValue[28] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_retinoscopy_sudut"]);
$dbValue[29] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_spheris_subj_tnp_myr"]);
$dbValue[30] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_cylinder_subj_tnp_myr"]);
$dbValue[31] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_sudut_subj_tnp_myr"]);
$dbValue[32] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_spheris_subj_tnp_myr"]);
$dbValue[33] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_cylinder_subj_tnp_myr"]);
$dbValue[34] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_sudut_subj_tnp_myr"]);
$dbValue[35] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_spheris_subj_dgn_myr"]);
$dbValue[36] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_cylinder_subj_dgn_myr"]);
$dbValue[37] = QuoteValue(DPE_CHAR,$_POST["ref_mata_od_koreksi_sudut_subj_dgn_myr"]);
$dbValue[38] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_spheris_subj_dgn_myr"]);
$dbValue[39] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_cylinder_subj_dgn_myr"]);
$dbValue[40] = QuoteValue(DPE_CHAR,$_POST["ref_mata_os_koreksi_sudut_subj_dgn_myr"]);
$dbValue[41] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_koreksi_od_subj_tnp_myr"]);
$dbValue[42] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_koreksi_os_subj_tnp_myr"]);
$dbValue[43] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_koreksi_od_subj_dgn_myr"]);
$dbValue[44] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_koreksi_os_subj_dgn_myr"]);
$dbValue[45] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_retinoscopy_od"]);
$dbValue[46] = QuoteValue(DPE_CHARKEY,$_POST["id_visus_retinoscopy_os"]);
...
for($i=0,$n=count($_POST["id_item"]);$i<$n;$i++) {
     ...
     $dbValue[5] = QuoteValue(DPE_NUMERIC,$_POST["txtJumlah_1"][$i]); 
...
$optionsNext[$count] = $view->RenderOption(STATUS_RUJUKAN,"Rujukan",$show); $count++;
//if(!$dataDiag){ $optionsNext[$count] = $view->RenderOption(STATUS_DIAGNOSTIK,"Ke Ruang Diagnostik",$show); $count++; }
//$optionsNext[$count] = $view->RenderOption(STATUS_PREOP,"Pre Operasi",$show); $count++;
//$optionsNext[$count] = $view->RenderOption(STATUS_RAWATINAP,"Rawat Inap",$show); $count++;
//$optionsNext[$count] = $view->RenderOption(STATUS_APOTEK,"Ke Apotik",$show); $count++;
...
$fotoHumpre = ($_POST["diag_gambar_humpre"]) ? $lokasiHumpre."/".$_POST["diag_gambar_humpre"] : $lokasiHumpre."/default.jpg";
$fotoUsg = ($_POST["diag_gambar_usg"]) ? $lokasiUSG."/".$_POST["diag_gambar_usg"] : $lokasiUSG."/default.jpg";
$fotoFundus = ($_POST["diag_gambar_fundus"]) ? $lokasiFundus."/".$_POST["diag_gambar_fundus"] : $lokasiFundus."/default.jpg";
$fotoOct = ($_POST["diag_gambar_oct"]) ? $lokasiOCT."/".$_POST["diag_gambar_oct"] : $lokasiOCT."/default.jpg";
...
function ajaxFileUploadUSG(){
      ...
      (
	      {
		      url:'perawatan_upload2.php?modenya=usg',
		      secureuri:false,
		      ...
		      success: function (data, status)
		      {
			      if(typeof(data.error) != 'undefined')
			      {
				      ...
				      {
					      alert(data.msg);
			 document.getElementById('diag_gambar_usg').value= data.file;
			 document.img_foto_usg.src='<?php echo $lokasiUSG."/";?>'+data.file;
				      }
			      }
		      },
		      error: function (data, status, e)
...
function ajaxFileUploadFundus(){
      ...
      (
	      {
		      url:'perawatan_upload2.php?modenya=fundus',
		      secureuri:false,
		      fileElementId:'fileToUpload2',
		      dataType: 'json',
		      success: function (data, status)
		      {
			      if(typeof(data.error) != 'undefined')
			      {
				      ...
				      {
					      alert(data.msg);
			 document.getElementById('diag_gambar_fundus').value= data.file;
			 document.img_foto_fundus.src='<?php echo $lokasiFundus."/";?>'+data.file;
				      }
			      }
		      },
		      error: function (data, status, e)
...
function ajaxFileUploadHumpre(){
      ...
      (
	      {
		      url:'perawatan_upload2.php?modenya=humpre',
		      secureuri:false,
		      fileElementId:'fileToUpload2',
		      dataType: 'json',
		      success: function (data, status)
		      {
			      if(typeof(data.error) != 'undefined')
			      {
				      ...
				      {
					      alert(data.msg);
			 document.getElementById('diag_gambar_humpre').value= data.file;
			 document.img_foto_humpre.src='<?php echo $lokasiHumpre."/";?>'+data.file;
				      }
			      }
		      },
		      error: function (data, status, e)
...
function ajaxFileUploadOCT(){
      ...
      (
	      {
		      url:'perawatan_upload2.php?modenya=oct',
		      secureuri:false,
		      fileElementId:'fileToUpload2',
		      dataType: 'json',
		      success: function (data, status)
		      {
			      if(typeof(data.error) != 'undefined')
			      {
				      ...
				      {
					      alert(data.msg);
			 document.getElementById('diag_gambar_oct').value= data.file;
			 document.img_foto_oct.src='<?php echo $lokasiOCT."/";?>'+data.file;
				      }
			      }
		      },
		      error: function (data, status, e)
...
mTimer = setInterval("timer()", 10000);
}
...
var drz;
function lihat(rawat_icd_od_nama_0){

if(rawat_icd_od_nama_0.length==0){
document.getElementById("kotaksugest").style.visibility = "hidden";
}else{
drz = buatajax();
var url="cari.php";
drz.onreadystatechange=stateChanged;
var params = "q="+rawat_icd_od_nama_0;
...
var drz1;
function lihat1(rawat_icd_od_nama_1){

if(rawat_icd_od_nama_1.length==0){
document.getElementById("kotaksugest1").style.visibility = "hidden";
}else{
drz1 = buatajax1();
var url="cari1.php";
drz1.onreadystatechange=stateChanged1;
var params1 = "q="+rawat_icd_od_nama_1;
...
var drz2;
function lihat2(rawat_icd_os_nama_0){

if(rawat_icd_os_nama_0.length==0){
document.getElementById("kotaksugest2").style.visibility = "hidden";
}else{
drz2 = buatajax2();
var url="cari2.php";
drz2.onreadystatechange=stateChanged2;
var params2 = "q="+rawat_icd_os_nama_0;
...
var drz3;
function lihat3(rawat_icd_os_nama_1){

if(rawat_icd_os_nama_1.length==0){
document.getElementById("kotaksugest3").style.visibility = "hidden";
}else{
drz3 = buatajax3();
var url="cari3.php";
drz3.onreadystatechange=stateChanged3;
var params3 = "q="+rawat_icd_os_nama_1;
...
var drz4;
function lihat4(rawat_ina_od_nama_0){

if(rawat_ina_od_nama_0.length==0){
document.getElementById("kotaksugest4").style.visibility = "hidden";
}else{
drz4 = buatajax4();
var url="cari4.php";
drz4.onreadystatechange=stateChanged4;
var params4 = "q="+rawat_ina_od_nama_0;
...
document.getElementById("rawat_ina_od_nama_0").value = rawat_ina_od_nama_0;
document.getElementById("rawat_ina_od_id_0").value = rawat_ina_od_id_0;
document.getElementById("rawat_ina_od_kode_0").value = rawat_ina_od_kode_0;
document.getElementById("kotaksugest4").style.visibility = "hidden";
document.getElementById("kotaksugest4").innerHTML = "";
}
...
var drz5;
function lihat5(rawat_ina_od_nama_1){

if(rawat_ina_od_nama_1.length==0){
document.getElementById("kotaksugest5").style.visibility = "hidden";
}else{
drz5 = buatajax5();
var url="cari5.php";
drz5.onreadystatechange=stateChanged5;
var params5 = "q="+rawat_ina_od_nama_1;
...
document.getElementById("rawat_ina_od_nama_1").value = rawat_ina_od_nama_1;
document.getElementById("rawat_ina_od_id_1").value = rawat_ina_od_id_1;
document.getElementById("rawat_ina_od_kode_1").value = rawat_ina_od_kode_1;
document.getElementById("kotaksugest5").style.visibility = "hidden";
document.getElementById("kotaksugest5").innerHTML = "";
}
...
var drz6;
function lihat6(rawat_ina_os_nama_0){

if(rawat_ina_os_nama_0.length==0){
document.getElementById("kotaksugest6").style.visibility = "hidden";
}else{
drz6 = buatajax6();
var url="cari6.php";
drz6.onreadystatechange=stateChanged6;
var params6 = "q="+rawat_ina_os_nama_0;
...
document.getElementById("rawat_ina_os_nama_0").value = rawat_ina_os_nama_0;
document.getElementById("rawat_ina_os_id_0").value = rawat_ina_os_id_0;
document.getElementById("rawat_ina_os_kode_0").value = rawat_ina_os_kode_0;
document.getElementById("kotaksugest6").style.visibility = "hidden";
document.getElementById("kotaksugest6").innerHTML = "";
}
...
var drz7;
function lihat7(rawat_ina_os_nama_1){

if(rawat_ina_os_nama_1.length==0){
document.getElementById("kotaksugest7").style.visibility = "hidden";
}else{
drz7 = buatajax7();
var url="cari7.php";
drz7.onreadystatechange=stateChanged7;
var params7 = "q="+rawat_ina_os_nama_1;
...
document.getElementById("rawat_ina_os_nama_1").value = rawat_ina_os_nama_1;
document.getElementById("rawat_ina_os_id_1").value = rawat_ina_os_id_1;
document.getElementById("rawat_ina_os_kode_1").value = rawat_ina_os_kode_1;
document.getElementById("kotaksugest7").style.visibility = "hidden";
document.getElementById("kotaksugest7").innerHTML = "";
}
...
<tr>
     <td width= "20%" align="left" class="tablecontent">Nama Orang Tua</td>
     <td width= "40%" align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_nama_ortu","ref_nama_ortu","40","200",$_POST["ref_nama_ortu"],"inputField", null,false);?></textarea></td>
</tr>
<tr>
     <td width= "20%" align="left" class="tablecontent">No. Telp</td>
     <td width= "40%" align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_no_telp","ref_no_telp","20","200",$_POST["ref_no_telp"],"inputField", null,false);?></textarea></td>
</tr>
<tr>
...
<tr>
     <td align="left" class="tablecontent">Asal Rujukan</td>
     <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("reg_asal_rujukan","reg_asal_rujukan","25","100",$_POST["reg_asal_rujukan"],"inputField", null,false);?></td>
</tr>
<tr>
     <td align="left" class="tablecontent">Anamnesa</td>
     <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("reg_anamnesa","reg_anamnesa","25","100",$_POST["reg_anamnesa"],"inputField", null,false);?></td>
</tr>
<tr>
     <td align="left" class="tablecontent">Diagnosa Sementara</td>
     <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("reg_diag_sementara","reg_diag_sementara","25","100",$_POST["reg_diag_sementara"],"inputField", null,false);?></td>
</tr>
<tr>
     <td align="left" class="tablecontent">Terapi Sementara</td>
     <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("reg_terapi_sementara","reg_terapi_sementara","25","100",$_POST["reg_terapi_sementara"],"inputField", null,false);?></td>
</tr>
<tr>
...
<!-- PERUBAHAN BULAN DESEMBER 2013 -->
<!-- pemeriksaan visus-->
<fieldset>
<legend><strong>Pemeriksaan Visus</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
     <td width="30%" align="center">Visus Tanpa Koreksi</td>
     <td width="30%" align="center">Visus Dengan Koreksi</td>
</tr>
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd" nowrap>
...
<fieldset>
<legend><strong>Pemeriksaan Autorefraktometer</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_ark_spheris","ref_mata_od_ark_spheris","15","15",$_POST["ref_mata_od_ark_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_ark_cylinder","ref_mata_od_ark_cylinder","15","15",$_POST["ref_mata_od_ark_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_ark_sudut","ref_mata_od_ark_sudut","15","15",$_POST["ref_mata_od_ark_sudut"],"inputField", null,false);?></td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_ark_spheris","ref_mata_os_ark_spheris","15","15",$_POST["ref_mata_os_ark_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_ark_cylinder","ref_mata_os_ark_cylinder","15","15",$_POST["ref_mata_os_ark_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_ark_sudut","ref_mata_os_ark_sudut","15","15",$_POST["ref_mata_os_ark_sudut"],"inputField", null,false);?></td>
</tr>
</table>
</fieldset>
...
<fieldset>
<legend><strong>Pemeriksaan Lensometer</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
     <td width="20%" align="center">Spheris</td>
     <td width="20%" align="center">Cylinder</td>
     <td width="20%" align="center">Sudut</td>
</tr>
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_lensometer_spheris","ref_mata_od_lensometer_spheris","15","15",$_POST["ref_mata_od_lensometer_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_lensometer_cylinder","ref_mata_od_lensometer_cylinder","15","15",$_POST["ref_mata_od_lensometer_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_lensometer_sudut","ref_mata_od_lensometer_sudut","15","15",$_POST["ref_mata_od_lensometer_sudut"],"inputField", null,false);?></td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_lensometer_spheris","ref_mata_os_lensometer_spheris","15","15",$_POST["ref_mata_os_lensometer_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_lensometer_cylinder","ref_mata_os_lensometer_cylinder","15","15",$_POST["ref_mata_os_lensometer_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_lensometer_sudut","ref_mata_os_lensometer_sudut","15","15",$_POST["ref_mata_os_lensometer_sudut"],"inputField", null,false);?></td>
</tr>
</table>
</fieldset>

<!-- pemeriksaan refraksi (subjective) tanpa mydriatikum-->
<fieldset>
<legend><strong>Pemeriksaan Refraksi (subjective) tanpa Mydriatikum</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
     <td width="30%" align="center">Spheris</td>
     <td width="30%" align="center">Cylinder</td>
     <td width="30%" align="center">Sudut</td>
     <td width="20%" align="center">Visus dengan Koreksi</td>
</tr>
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_spheris_subj_tnp_myr","ref_mata_od_koreksi_spheris_subj_tnp_myr","15","15",$_POST["ref_mata_od_koreksi_spheris_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_cylinder_subj_tnp_myr","ref_mata_od_koreksi_cylinder_subj_tnp_myr","15","15",$_POST["ref_mata_od_koreksi_cylinder_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_sudut_subj_tnp_myr","ref_mata_od_koreksi_sudut_subj_tnp_myr","15","15",$_POST["ref_mata_od_koreksi_sudut_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_koreksi_od_subj_tnp_myr","id_visus_koreksi_od_subj_tnp_myr",$optVisusKoreksiOD,null,null,null);?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_spheris_subj_tnp_myr","ref_mata_os_koreksi_spheris_subj_tnp_myr","15","15",$_POST["ref_mata_os_koreksi_spheris_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_cylinder_subj_tnp_myr","ref_mata_os_koreksi_cylinder_subj_tnp_myr","15","15",$_POST["ref_mata_os_koreksi_cylinder_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_sudut_subj_tnp_myr","ref_mata_os_koreksi_sudut_subj_tnp_myr","15","15",$_POST["ref_mata_os_koreksi_sudut_subj_tnp_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_koreksi_os_subj_tnp_myr","id_visus_koreksi_os_subj_tnp_myr",$optVisusKoreksiOS,null,null,null);?>
     </td>
</tr>
</table>
</fieldset>

<!-- pemeriksaan refraksi (subjective) dengan mydriatikum-->
<fieldset>
<legend><strong>Pemeriksaan Refraksi (subjective) dengan Mydriatikum</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
     <td width="30%" align="center">Spheris</td>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_spheris_subj_dgn_myr","ref_mata_od_koreksi_spheris_subj_dgn_myr","15","15",$_POST["ref_mata_od_koreksi_spheris_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_cylinder_subj_dgn_myr","ref_mata_od_koreksi_cylinder_subj_dgn_myr","15","15",$_POST["ref_mata_od_koreksi_cylinder_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_koreksi_sudut_subj_dgn_myr","ref_mata_od_koreksi_sudut_subj_dgn_myr","15","15",$_POST["ref_mata_od_koreksi_sudut_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_koreksi_od_subj_dgn_myr","id_visus_koreksi_od_subj_dgn_myr",$optVisusKoreksiOD,null,null,null);?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_spheris_subj_dgn_myr","ref_mata_os_koreksi_spheris_subj_dgn_myr","15","15",$_POST["ref_mata_os_koreksi_spheris_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_cylinder_subj_dgn_myr","ref_mata_os_koreksi_cylinder_subj_dgn_myr","15","15",$_POST["ref_mata_os_koreksi_cylinder_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_koreksi_sudut_subj_dgn_myr","ref_mata_os_koreksi_sudut_subj_dgn_myr","15","15",$_POST["ref_mata_os_koreksi_sudut_subj_dgn_myr"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_koreksi_os_subj_dgn_myr","id_visus_koreksi_os_subj_dgn_myr",$optVisusKoreksiOS,null,null,null);?>
     </td>
</tr>
</table>
</fieldset>
...
<fieldset>
<legend><strong>Pemeriksaan Streak Retinoscopy</strong></legend>
<table width="100%" border="1" cellpadding="4" cellspacing="1">
<tr class="subheader">
     <td width="5%" align="center">Mata</td>
     <td width="30%" align="center">Spheris</td>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_retinoscopy_spheris","ref_mata_od_retinoscopy_spheris","15","15",$_POST["ref_mata_od_retinoscopy_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_retinoscopy_cylinder","ref_mata_od_retinoscopy_cylinder","15","15",$_POST["ref_mata_od_retinoscopy_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_od_retinoscopy_sudut","ref_mata_od_retinoscopy_sudut","15","15",$_POST["ref_mata_od_retinoscopy_sudut"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_retinoscopy_od","id_visus_retinoscopy_od",$optVisusKoreksiOD,null,null,null);?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_retinoscopy_spheris","ref_mata_os_retinoscopy_spheris","15","15",$_POST["ref_mata_os_retinoscopy_spheris"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_retinoscopy_cylinder","ref_mata_os_retinoscopy_cylinder","15","15",$_POST["ref_mata_os_retinoscopy_cylinder"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd"><?php echo $view->RenderTextBox("ref_mata_os_retinoscopy_sudut","ref_mata_os_retinoscopy_sudut","15","15",$_POST["ref_mata_os_retinoscopy_sudut"],"inputField", null,false);?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $view->RenderComboBox("id_visus_retinoscopy_os","id_visus_retinoscopy_os",$optVisusKoreksiOS,null,null,null);?>
     </td>
</tr>
</table>
</fieldset>
<!-- END OF PERUBAHAN BULAN DESEMBER 2013-->
...
<tr>
     ...
     <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextArea("rawat_color_blindness","rawat_color_blindness","3","30",$_POST["rawat_color_blindness"],"inputField", null,false);?></td>
</tr>
</table>
</fieldset>
...
<tr>
     ...
     <td align="left" class="tablecontent-odd">
	  <?php echo $view->RenderTextBox("rawat_icd_od_kode[0]","rawat_icd_od_kode_0","10","100",$_POST["rawat_icd_od_kode"][0],"inputField", null,false);?>
     ...
     <?php// echo $view->RenderTextBox("rawat_icd_od_nama[0]","rawat_icd_od_nama_0","50","100",$_POST["rawat_icd_od_nama"][0],"inputField", null,false,"onkeyup='lihat(this.value)'" );?>      
    <input type="text" size= "50" name="rawat_icd_od_nama[0]" id="rawat_icd_od_nama_0" value="<?php echo $_POST["rawat_icd_od_nama"][0]?>" onkeyup="lihat(this.value)" />
      </div>
...
<tr>
     ...
     <td align="left" class="tablecontent-odd">
	  <?php echo $view->RenderTextBox("rawat_icd_od_kode[1]","rawat_icd_od_kode_1","10","100",$_POST["rawat_icd_od_kode"][1],"inputField", null,false);?>
...
<td align="left" class="tablecontent-odd"><div>      
    <input type="text" size= "50" name="rawat_icd_od_nama[1]" id="rawat_icd_od_nama_1" value="<?php echo $_POST["rawat_icd_od_nama"][1]?>" onkeyup="lihat1(this.value)" />
      </div>
      <div id=kotaksugest1 style="position:absolute;
      background-color:lightblue;width:420;visibility:hidden;z-index:100">
      </div>
</td> 
</tr>
...
<tr>
     <td align="left" class="tablecontent">1</td>
     <td align="left" class="tablecontent-odd">
	  <?php echo $view->RenderTextBox("rawat_icd_os_kode[0]","rawat_icd_os_kode_0","10","100",$_POST["rawat_icd_os_kode"][0],"inputField", null,false);?>
...
<td align="left" class="tablecontent-odd"><div>      
    <input type="text" size= "50" name="rawat_icd_os_nama[0]" id="rawat_icd_os_nama_0" value="<?php echo $_POST["rawat_icd_os_nama"][0]?>" onkeyup="lihat2(this.value)" />
      </div>
      <div id=kotaksugest2 style="position:absolute;
      background-color:lightblue;width:420;visibility:hidden;z-index:100">
      </div>
</td> 
</tr>
<tr>
     <td align="left" class="tablecontent">2</td>
     <td align="left" class="tablecontent-odd">
	  <?php echo $view->RenderTextBox("rawat_icd_os_kode[1]","rawat_icd_os_kode_1","10","100",$_POST["rawat_icd_os_kode"][1],"inputField", null,false);?>
...
<td align="left" class="tablecontent-odd"><div>      
    <input type="text" size= "50" name="rawat_icd_os_nama[1]" id="rawat_icd_os_nama_1" value="<?php echo $_POST["rawat_icd_os_nama"][1]?>" onkeyup="lihat3(this.value)" />
      </div>
      <div id=kotaksugest3 style="position:absolute;
      background-color:lightblue;width:420;visibility:hidden;z-index:100">
      </div>
</td> 
</tr>
...
<!-- Bagian Diagnosa | update tanggal 23 Januari 2014 --> 
      <table width="100%" border="1" cellpadding="4" cellspacing="1">
	      <tr>
		       <td width="100%">
		       ...
		       <table width="100%" border="1" cellpadding="4" cellspacing="1">
				...
				<tr>
					 ...
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_k1_od","diag_k1_od",15,15,$_POST["diag_k1_od"],"inputfield",null,false);?></td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_k1_os","diag_k1_os",15,15,$_POST["diag_k1_os"],"inputfield",null,false);?></td>
				</tr>
				<tr>
					 <td align="left" class="tablecontent">K2</td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_k2_od","diag_k2_od",15,15,$_POST["diag_k2_od"],null,false);?></td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_k2_os","diag_k2_os",15,15,$_POST["diag_k2_os"],null,false);?></td>
				</tr>
		      </table>
		       </fieldset>
		       ...
		       <table width="100%" border="1" cellpadding="4" cellspacing="1">
				...
				<tr>
					 ...
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_acial_od","diag_acial_od",15,15,$_POST["diag_acial_od"],null,false);?></td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_acial_os","diag_acial_os",15,15,$_POST["diag_acial_os"],null,false);?></td>
				</tr>
				<tr>
					 <td align="left" class="tablecontent">Power IOL</td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_iol_od","diag_iol_od",15,15,$_POST["diag_iol_od"],null,false);?></td>
					 <td align="center" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_iol_os","diag_iol_os",15,15,$_POST["diag_iol_os"],null,false);?></td>
				</tr>
		      </table>
		       </fieldset>
		       ...
		       <table width="100%" border="1" cellpadding="4" cellspacing="1">
				<tr>
					 ...
					 <td align="left" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_coa","diag_coa",15,15,$_POST["diag_coa"],null,false);?></td>
				</tr>
				<tr>
					 <td align="left" class="tablecontent">Lensa</td>
					 <td align="left" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_coa","diag_coa",15,15,$_POST["diag_lensa"],null,false);?></td>
				</tr>
				<tr>
				...
				<tr>
					 ...
					 <td align="left" class="tablecontent-odd">&nbsp;<?php echo $view->RenderTextBox("diag_coa","diag_coa",15,15,nl2br($_POST["diag_kesimpulan"]),null,false);?></td>
				</tr>
		      </table>
		       </fieldset>
		       ...
		       <fieldset>
		       <legend><strong>Gambar Mata Diagnostik Hari Ini</strong></legend>
		       <table width="100%" border="1" cellpadding="2" cellspacing="1">
				<tr>
					 <td align="center" width="40%" class="tablecontent-odd">
						      <img hspace="2" width="120" height="150" name="img_foto_usg" id="img_foto_usg" src="<?php echo $fotoUsg;?>"  border="1">
						      <input type="hidden" name="diag_gambar_usg" id="diag_gambar_usg" value="<?php echo $_POST["diag_gambar_usg"];?>">
					      </td>
					 <td align="center" width="40%" class="tablecontent-odd">
						      <img hspace="2" width="120" height="150" name="img_foto_fundus" id="img_foto_fundus" src="<?php echo $fotoFundus;?>"  border="1">
						      <input type="hidden" name="diag_gambar_fundus" id="diag_gambar_fundus" value="<?php echo $_POST["diag_gambar_fundus"];?>">
					      </td>
				</tr>
				<tr>
					 <td align="center" class="tablecontent"><button class="button" id="buttonUpload" onclick="return ajaxFileUploadUSG();">Upload USG</button></td>
					 <td align="center" class="tablecontent"><button class="button" id="buttonUpload" onclick="return ajaxFileUploadFundus();">Upload Fundus</button></td>
				</tr>
				<tr>
					 <td align="center" width="40%" class="tablecontent-odd">
						      <img hspace="2" width="120" height="150" name="img_foto_humpre" id="img_foto_humpre" src="<?php echo $fotoHumpre;?>"  border="1">
						      <input type="hidden" name="diag_gambar_humpre" id="diag_gambar_humpre" value="<?php echo $_POST["diag_gambar_humpre"];?>">
					      </td>
					 <td align="center" width="40%" class="tablecontent-odd">
						      <img hspace="2" width="120" height="150" name="img_foto_oct" id="img_foto_oct" src="<?php echo $fotoOct;?>"  border="1">
						      <input type="hidden" name="diag_gambar_oct" id="diag_gambar_oct" value="<?php echo $_POST["diag_gambar_oct"];?>">
					      </td>
				</tr>
				<tr>
					 <td align="center" class="tablecontent"><button class="button" id="buttonUpload" onclick="return ajaxFileUploadHumpre();">Upload Humpreys</button></td>
					 <td align="center" class="tablecontent"><button class="button" id="buttonUpload" onclick="return ajaxFileUploadOCT();">Upload OCT</button></td>
				</tr>
			      <tr>
				 <td colspan=2 align="center">
					      <div id="loading" style="display:none;"><img id="imgloading" src="<?php echo $APLICATION_ROOT;?>images/loading.gif"></div> 
					      <input id="fileToUpload2" type="file" size="35" name="fileToUpload2" class="inputField">
				 </td>
		      </table>
	      </fieldset>
<!--
		       <fieldset>
		       <legend><strong>Gambar Mata</strong></legend>
		       <table width="100%" border="1" cellpadding="4" cellspacing="1">
			      <?php for($i=0,$n=count($dataMata);$i<$n;$i++) { ?>
				<tr>
					 <td align="left" width="40%" class="tablecontent-odd"><img hspace="2" width="120" height="150" name="img_foto" id="img_foto" src="<?php echo $lokasi.$dataMata[$i]["rawat_mata_foto"];?>"  border="1"></td>
					 <td align="left" class="tablecontent-odd">&nbsp;<?php echo $dataMata[$i]["rawat_waktu"];?></td>
				</tr>
			      <?php } ?>
		      </table>
		       </fieldset>
...
<?php echo $view->SetFocus("ref_nama_ortu");?>
