...
<!--          <tr>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_icd_od_nama[0]","rawat_icd_od_nama_0","50","100",$_POST["rawat_icd_od_nama"][0],"inputField", null,false);?></td>
          </tr>
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_icd_od_nama[1]","rawat_icd_od_nama_1","50","100",$_POST["rawat_icd_od_nama"][1],"inputField", null,false);?></td>
          </tr>
	</table>
     </fieldset>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_icd_os_nama[0]","rawat_icd_os_nama_0","50","100",$_POST["rawat_icd_os_nama"][0],"inputField", null,false);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">2</td>
               <td align="left" class="tablecontent-odd">
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_icd_os_nama[1]","rawat_icd_os_nama_1","50","100",$_POST["rawat_icd_os_nama"][1],"inputField", null,false);?></td>
          </tr>
	</table>
     </fieldset>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_ina_od_nama[0]","rawat_ina_od_nama_0","50","100",$_POST["rawat_ina_od_nama"][0],"inputField", null,false);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">2</td>
               <td align="left" class="tablecontent-odd">
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_ina_od_nama[1]","rawat_ina_od_nama_1","50","100",$_POST["rawat_ina_od_nama"][1],"inputField", null,false);?></td>
          </tr>
	</table>
     </fieldset>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_ina_os_nama[0]","rawat_ina_os_nama_0","50","100",$_POST["rawat_ina_os_nama"][0],"inputField", null,false);?></td>
          </tr>
          <tr>
               <td align="left" class="tablecontent">2</td>
               <td align="left" class="tablecontent-odd">
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderTextBox("rawat_ina_os_nama[1]","rawat_ina_os_nama_1","50","100",$_POST["rawat_ina_os_nama"][1],"inputField", null,false);?></td>
          </tr>
	</table>
     </fieldset>
