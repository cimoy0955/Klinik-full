	...
	$page[STATUS_PREOP] = "preop.php";
     ...
     function GetTindakan($status) { 
          ...
          $sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu from klinik.klinik_registrasi a join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id
                    where (a.reg_status like '".STATUS_OPERASI_JADWAL.$status."' or a.reg_status like '".STATUS_BEDAH.$status."') and a.reg_tipe_umur = 'A'
   ...
   /*       $sql = "delete from klinik.klinik_perawatan_operasi_suster_asisten where id_op = ".QuoteValue(DPE_CHAR,$_POST["op_id"]);
     ...
     for($i=0,$n=count($dataOperasiPaket);$i<$n;$i++) {
      ...
      $count=0;	
    	...
    	$optionsNext[$count] = $view->RenderOption(STATUS_RUJUKAN,$rawatStatus[STATUS_RUJUKAN],$show); $count++;
...
<tr>
     ...
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_nonkoreksi_od"];?>
     </td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_od"];?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_nonkoreksi_os"];?>
     </td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_os"];?>
     </td>
</tr>
</table>
</fieldset>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_ark_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_ark_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_ark_sudut"];?></td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_ark_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_ark_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_ark_sudut"];?></td>
</tr>
</table>
</fieldset>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_lensometer_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_lensometer_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_lensometer_sudut"];?></td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_lensometer_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_lensometer_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_lensometer_sudut"];?></td>
</tr>
</table>
</fieldset>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_spheris_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_cylinder_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_sudut_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_od_subj_tnp_myr"];?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_spheris_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_cylinder_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_sudut_subj_tnp_myr"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_os_subj_tnp_myr"];?>
     </td>
</tr>
</table>
</fieldset>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_spheris_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_cylinder_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_koreksi_sudut_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_od_subj_dgn_myr"];?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_spheris_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_cylinder_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_koreksi_sudut_subj_dgn_myr"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_koreksi_os_subj_dgn_myr"];?>
     </td>
</tr>
</table>
</fieldset>
...
<tr>
     <td align="center" class="tablecontent">OD</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_retinoscopy_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_retinoscopy_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_od_retinoscopy_sudut"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_retinoscopy_od"];?>
     </td>
</tr>
<tr>
     <td align="center" class="tablecontent">OS</td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_retinoscopy_spheris"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_retinoscopy_cylinder"];?></td>
     <td align="center" class="tablecontent-odd"><?php echo $_POST["ref_mata_os_retinoscopy_sudut"];?></td>
     <td align="center" class="tablecontent-odd" nowrap>
	  <?php echo $_POST["id_visus_retinoscopy_os"];?>
     </td>
</tr>
</table>
</fieldset>
<!-- END OF PERUBAHAN BULAN JANUARI 2014-->
