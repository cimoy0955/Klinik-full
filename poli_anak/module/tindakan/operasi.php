     ...
     function GetPreme() {
          ...
          $sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu, fol_lunas 
				...
				and c.id_biaya = ".QuoteValue(DPE_CHAR,BIAYA_GULA_PREOP)." 
                    where a.reg_status like '".STATUS_PREMEDIKASI.STATUS_ANTRI."'  order by reg_status desc, reg_tanggal asc, reg_waktu asc";
...
<fieldset>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
		<tr>
			<td align="center"><?php echo $view->RenderButton(BTN_SUBMIT,($_x_mode == "Edit") ? "btnUpdate" : "btnSave","btnSave","Simpan","button",false,"onClick=\"return CheckSimpan(this.form);\"");?>  <input type="submit" name="btnDel" id="btnDel" value="Batal" class="button" /></td>
