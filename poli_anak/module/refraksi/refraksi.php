<?php
          ...
          $sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu, a.reg_jadwal, z.fol_lunas, a.reg_jenis_pasien 
		    ...
		    left join (
			 ...
			 where fol_lunas = 'n' and fol_jenis = '".STATUS_REGISTRASI."' 
                    ...
                    where a.reg_status like '".STATUS_REFRAKSI.$status."'  and a.reg_tipe_umur = 'A'
	...
	if($_GET["id_reg"] ) {
		$sql = "select cust_usr_nama,cust_usr_kode,cust_usr_ortu,cust_usr_telp,b.cust_usr_jenis_kelamin, 
