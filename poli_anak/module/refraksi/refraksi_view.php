<?php
	...
	if($_POST["cust_usr_id"]) {
     ...
     if($dataPasien) {
          ...
          $sql = "select a.ref_id, a.ref_tanggal from klinik.klinik_refraksi a where a.id_cust_usr = ".QuoteValue(DPE_CHAR,$_POST["cust_usr_id"])." 
          ...
          $isAllowedUpdate = $auth->IsAllowed("poli_anak",PRIV_UPDATE);
