<?php
     ...
     $plx = new InoLiveX("GetOperasi,GetPerawatan");     
     ...
     function GetOperasi() {     
          ...
          $sql = "select cust_usr_nama,a.reg_status, a.reg_waktu from klinik.klinik_registrasi a join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id
                    where a.reg_status like '".STATUS_OPERASI."%'  and a.reg_tipe_umur = 'A'
     ...
     function GetPerawatan() {     
          ...
          $sql = "select cust_usr_nama,a.reg_status, a.reg_waktu from klinik.klinik_registrasi a join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id
                    where a.reg_status like '".STATUS_PEMERIKSAAN."%'  and a.reg_tipe_umur = 'A'
                    order by reg_status desc, reg_tanggal asc, reg_waktu asc";
          $dataTable = $dtaccess->FetchAll($sql);
