<?php
	...
	$tree = new CTree("global.global_customer","cust_id",TREE_LENGTH);
     ...
     $_x_mode = "New";
     $thisPage = "operasi_view.php";
     $editPage = "operasi.php?";
	...
	if($_POST["cust_usr_id"]) {
     ...
     if($dataPasien) {
          ...
          $sql = "select a.op_id,  CAST(op_waktu as date) as op_tanggal from klinik.klinik_operasi a where a.id_cust_usr = ".QuoteValue(DPE_NUMERIC,$_POST["cust_usr_id"])." 
                    order by a.op_waktu desc";
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" colspan=2 class="tableheader">Data Pasien Operasi</td>
	</tr>
</table> 
