...
function sendValue(id,nama) {
	...
	self.parent.document.getElementById('op_asisten_suster_terapi_nama_<?php echo $_GET["el"];?>').value = nama;
	self.parent.document.getElementById('id_asisten_suster_terapi_<?php echo $_GET["el"];?>').value = id;
