...
<body>
<table width="150" height="100"  celpadding="0" cellspacing="0" noborder border ="0" style="margin-top:-0.4cm;">
	<tr>
		<td>
          ...
          <td>&nbsp;</td> 
					...
					<BR>
					<font size="2"><label>&nbsp;<?php echo format_date($dataItem["reg_tanggal"]);?></label></font>
					 <BR>
						<?php 
							if ($obj) {
								if ($check_error) {
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
					<td align="center" width="60%"><font size="2"><label>&nbsp;<?php echo $dataItem["cust_usr_kode"];?> / 
          <?php echo $bayarPasien2[$dataItem["reg_jenis_pasien"]]; ?> </label></font></td>
				</tr>					
				<tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
