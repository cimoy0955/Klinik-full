...
$kata = $_POST['q'];
$query = "select biaya_id,biaya_nama,biaya_total,biaya_kode from klinik.klinik_biaya where upper(biaya_kode) like '".strtoupper($kata)."%' and biaya_kode is not null and biaya_kode like 'OP%' order by biaya_kode limit 10 ";
