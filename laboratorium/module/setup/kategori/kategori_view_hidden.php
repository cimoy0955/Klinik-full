<?php
     ...
     $thisPage = "kategori_view_hidden.php?";
     ...
     $sql = "select a.* from lab_kategori a where is_active = 'n'
               order by a.kategori_nama ";
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          if($isAllowedDel) {
               $tbContent[$i][$counter][TABLE_ISI] = '<input type="checkbox" name="cbEnable[]" value="'.$dataTable[$i]["kategori_id"].'">';               
