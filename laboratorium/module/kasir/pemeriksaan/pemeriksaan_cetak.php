...
<html>
  ...
  <table border="0" cellpadding="2" cellspacing="0" style="align:left" width="90%">
    <tr>
  ...
  <br />
  <br />
  <table border="0" cellpadding="2" cellspacing="0" style="align:left; font-size:10px;" width="98%">
    <tr>
  ...
  <br />
  <table border="1" cellpadding="1" cellspacing="0" style="align:left; font-size:9px;" width="98%" style="border-style:double;">
	<tr bgcolor="gray">
    ...
    <?php for($i=0;$i<count($data_pemeriksaan);$i++){ ?>
      ...
      <?php 
        if ($dataTable[$i]["kegiatan_nilai_normal_dewasa_laki"]) $normalValue = $dataTable[$i]["kegiatan_nilai_normal_dewasa_laki"];
         elseif (($dataTable[$i]["kegiatan_nilai_normal_dewasa_laki"]) && ($dataTable[$i]["kegiatan_nilai_normal_dewasa_wanita"])) $normalValue = "L: ".$dataTable[$i]["kegiatan_nilai_normal_dewasa_laki"].";&nbsp;&nbsp;".
                         "P: ".$dataTable[$i]["kegiatan_nilai_normal_dewasa_wanita"];

         if ($dataTable[$i]["kegiatan_nilai_normal_dewasa_anak"]) $normalValue .= ";&nbsp;&nbsp;A: ".$dataTable[$i]["kegiatan_nilai_normal_dewasa_wanita"];
      ?>
          ...
          <td style="padding-left:10px;"><?php echo $normalValue;?>&nbsp;<?php echo ($data_pemeriksaan[$i]["kegiatan_satuan"]);?></td>
        </tr>
    <?php }?>
  </table>
