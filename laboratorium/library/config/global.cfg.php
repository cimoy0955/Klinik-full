...
DEFINE("DIVISI_DOKTER_DALAM","DD");
DEFINE("DIVISI_DOKTER_LUAR","DL");

$divisi_dokter[DIVISI_DOKTER_DALAM] = "Dokter Lab Dalam";
$divisi_dokter[DIVISI_DOKTER_LUAR] = "Dokter Lab Luar";

DEFINE("MENIKAH_SUDAH","S");
DEFINE("MENIKAH_BELUM","B");
DEFINE("MENIKAH_DUDA","D");
DEFINE("MENIKAH_JANDA","J");

$status_menikah[MENIKAH_BELUM] = "Belum Menikah";
$status_menikah[MENIKAH_SUDAH] = "Sudah Menikah";
$status_menikah[MENIKAH_DUDA] = "Duda";
$status_menikah[MENIKAH_JANDA] = "Janda";

DEFINE("AGAMA_ISLAM","I");
DEFINE("AGAMA_KATOLIK","K");
DEFINE("AGAMA_PROTESTAN","P");
DEFINE("AGAMA_HINDU","H");
DEFINE("AGAMA_BUDHA","B");

$agamanya[AGAMA_ISLAM] = "Islam";
$agamanya[AGAMA_KATOLIK] = "Katolik";
$agamanya[AGAMA_PROTESTAN] = "Protestan";
$agamanya[AGAMA_HINDU] = "Hindu";
$agamanya[AGAMA_BUDHA] = "Budha";

DEFINE("GOLDARAH_O","O");
DEFINE("GOLDARAH_A","A");
DEFINE("GOLDARAH_B","B");
DEFINE("GOLDARAH_AB","AB");
