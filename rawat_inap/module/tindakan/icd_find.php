...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('rawat_icd_kode_<?php echo $_GET["el"];?>').value = kode;
	self.parent.document.getElementById('rawat_icd_nama_<?php echo $_GET["el"];?>').value = nama;
	self.parent.document.getElementById('rawat_icd_id_<?php echo $_GET["el"];?>').value = id;
