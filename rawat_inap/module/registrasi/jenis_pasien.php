<?php
	...
	$tree = new CTree("global.global_customer","cust_id",TREE_LENGTH);
 	...
 	if(!$auth->IsAllowed("edit_jenis_pasien",PRIV_CREATE)){
          die("access_denied");
          exit(1);
     } else if($auth->IsAllowed("edit_jenis_pasien",PRIV_CREATE)===1){
	...
	if($_POST["btnLanjut"]) {
		$sql = "select a.*,c.reg_status,b.cust_nama,reg_jenis_pasien  from global.global_customer_user a
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" colspan=2 class="tableheader">Edit Jenis PASIEN</td>
	</tr>
</table> 
...
<?php if($_POST["cust_usr_id"] && ($_POST["reg_status_pasien"]==STATUS_REGISTRASI || $_POST["reg_status_pasien"]==STATUS_REFRAKSI)) { ?>
