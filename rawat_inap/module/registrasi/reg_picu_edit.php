<?php
	...
	$auth = new CAuth();
     ...
     if ($_POST["btnSave"]) {         
		...
		if($_POST["reg_status"]!=STATUS_PEMERIKSAAN){
      ...
      where reg_id = ".QuoteValue(DPE_CHAR,$regId);
		...
		header("location:reg_picu_view.php");
		exit();      
     }
...
<tr>
     <td>
     <fieldset>
     <legend><strong>Proses Registrasi PICU</strong></legend>
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               <td colspan="2" align="right">
                    ...
                    <?php echo $view->RenderButton(BTN_BUTTON,"btnBack","btnBack","Kembali","button",false,"onClick=\"document.location.href='reg_icu_view.php';\"");?>                    
               </td>
          </tr>
     </table>
     </fieldset>
