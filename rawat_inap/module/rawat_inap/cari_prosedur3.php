...
for($i=0,$n=count($dataTable);$i<$n;$i++) {
    ...
    echo '<li onClick="isi11(\''.$dataTable[$i]["prosedur_nama"].'\',\''.$dataTable[$i]["prosedur_id"].'\',\''.$dataTable[$i]["prosedur_kode"].'\');" style="cursor:pointer">'.$dataTable[$i]["prosedur_kode"].'</li><br />';
