...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('rawat_icd_<?php echo $_GET["tipe"];?>_kode_<?php echo $_GET["el"];?>').value = kode;
	self.parent.document.getElementById('rawat_icd_<?php echo $_GET["tipe"];?>_nama_<?php echo $_GET["el"];?>').value = nama;
	self.parent.document.getElementById('rawat_icd_<?php echo $_GET["tipe"];?>_id_<?php echo $_GET["el"];?>').value = id;
