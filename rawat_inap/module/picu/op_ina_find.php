...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('op_ina_kode').value = kode;
	self.parent.document.getElementById('op_ina_nama').value = nama;
	self.parent.document.getElementById('id_ina').value = id;
