...
function sendValue(id,kode,nama) {
	...
	self.parent.document.getElementById('op_icd_kode').value = kode;
	self.parent.document.getElementById('op_icd_nama').value = nama;
	self.parent.document.getElementById('id_icd').value = id;
