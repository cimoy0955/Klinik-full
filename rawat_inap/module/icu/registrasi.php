<?php
	...
	$dtaccess = new DataAccess();
     ...
     function GetRawatinap($status) {
        ...
        where a.reg_status like '".STATUS_ICU.$status."' and a.reg_ugd = 'n' order by reg_status desc, reg_tanggal asc, reg_waktu asc";
          //echo $sql;
     ...
     function SetRawatinap($id) {
		...
		$sql = "update klinik.klinik_registrasi set reg_status = '".STATUS_ICU.STATUS_PROSES."' where reg_id = ".QuoteValue(DPE_CHAR,$id);
	...
	if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
          ...
          $sqlUpdate = "update klinik_registrasi set reg_status='".STATUS_ICU.STATUS_MENGINAP."' where reg_id = ".QuoteValue(DPE_CHAR,$_POST["id_reg"]);
          $dtaccess->Execute($sqlUpdate,DB_SCHEMA_KLINIK);
