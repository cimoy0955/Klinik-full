...
/*			$menu[$countMenu]["head"] = "Keluar RS";
			...
			$menu[$countMenu]["head"] = "Mutasi Kamar";
			$menu[$countMenu]["priv"] = "rawat_inap";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/rawat_inap/mutasi_kamar.php";
			$menu[$countMenu]["status"] = true;	
			$countMenu++;
			*/
		/*	$menu[$countMenu]["head"] = "Mutasi Dokter";
			$menu[$countMenu]["priv"] = "rawat_inap";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/rawat_inap/mutasi_dokter.php";
			$menu[$countMenu]["status"] = true;	
			$countMenu++;
			
			$menu[$countMenu]["head"] = "Saldo Stok ";
			$menu[$countMenu]["priv"] = "rawat_inap";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/rawat_inap/trans_opname.php";
			$menu[$countMenu]["status"] = true;	
			$countMenu++;
			*/
...
*/			
	...
	/*		$menu[$countMenu]["head"] = "Report Evaluasi Operasi";
			...
			$menu[$countMenu]["head"] = "Report Mutasi Kamar";
			$menu[$countMenu]["priv"] = "rawat_inap";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/rawat_inap/report_mutasi_kamar.php";
			$menu[$countMenu]["status"] = true;	
			$countMenu++;
			
			/*$menu[$countMenu]["head"] = "Report Mutasi Dokter";
			$menu[$countMenu]["priv"] = "rawat_inap";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/rawat_inap/report_mutasi_dokter.php";
			$menu[$countMenu]["status"] = true;	
			$countMenu++;*/
