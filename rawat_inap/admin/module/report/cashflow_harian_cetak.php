 <?php
     ...
     $sql_where[] = "a.trans_create >= ".QuoteValue(DPE_DATE,date_db($_GET["tanggal_awal"]));
     $sql_where[] = "a.trans_create <= ".QuoteValue(DPE_DATE,DateAdd(date_db($_GET["tanggal_akhir"]),1));
     ...
     function RenderHTML($email=false){
          ...
          <tr>
               ...
               <td width="10%" align="center">PETUGAS</td>
         ...
         ';
                  for($i=0,$n=count($dataCashflow);$i<$n;$i++){ 
                    ...
                    $html .= '<td>&nbsp;'.$dataCashflow[$i]["trans_petugas"].'</td>';     
                    $html .= '</tr>';
                    }
                     $html .='
