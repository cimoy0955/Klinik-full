 <?php
     ...
     $sql = "select distinct c.item_nama, c.id_item,c.transaksi_jumlah,c.transaksi_jumlah,c.id_penjualan,
              c.transaksi_harga_jual,c.transaksi_total, 
     ...
     function RenderHTML($email=false){
          ...
          <table width="800" border="0" cellpadding="0" cellspacing="0">
          <tr>
               <td align="center" colspan="2"><strong><font size="3"><u>LAPORAN PENDAPATAN GLOBAL</u></font></strong></td>       
          </tr>
          <tr>
               <td align="left">&nbsp;</td>
               <td align="left">&nbsp;</td>
          ...
          <tr>
               ...
               <td width="10%" align="center">TOTAL TAX</td>';
      if ($penjualanTipe == "--")
      $html .='<td width="10%" align="center">TIPE BAYAR</td>';
      if ($penjualanOutlet == "--")
      $html .='<td width="10%" align="center">OUTLET</td>';
      if ($penjualanPetugas == "--")
      $html .='<td width="10%" align="center">PETUGAS</td>';         
          ...
          $html .='<tr>
                   ...
                   <td width="10%" align="center" colspan="2">SUB TOTAL</td>';
                  ...
                  for($i=0,$n=count($dataCashflow);$i<$n;$i++){ 
                      ...
                      $html .= '<td align="center">'.$dataCashflow[$i]["penjualan_nomer"].'</td>';
                      $html .= '<td align="center">'.$dataCashflow[$i]["penjualan_customer"].'</td>';
                      $html .= '<td align="right">'.currency_format($dataCashflow[$i]["penjualan_total"]).'</td>';
                      $html .= '<td align="right">'.currency_format($dataCashflow[$i]["penjualan_ppn"]).'</td>';
                      if ($penjualanTipe == "--") $html .= '<td align="center">'.$tipeBayar.'</td>';
                      if ($penjualanOutlet == "--") $html .= '<td align="center">'.$dataCashflow[$i]["dep_nama"].'</td>';
                      if ($penjualanPetugas == "--") $html .= '<td align="center">'.$dataCashflow[$i]["penjualan_petugas"].'</td>';
                      $html .= '</tr>';
                      $j=0;
                      }
                      $j++;
                      ...
                      $html .= '<td style="text-align:left">&nbsp;'.$dataCashflow[$i]["item_nama"].'</td>';
                      $html .= '<td style="text-align:left">&nbsp;'.$dataCashflow[$i]["transaksi_jumlah"].'</td>';
                      $html .= '<td style="text-align:left">&nbsp;'.currency_format($dataCashflow[$i]["transaksi_harga_jual"]).'</td>';
                      $html .= '<td style="text-align:left">&nbsp;'.currency_format($dataCashflow[$i]["transaksi_total"]).'</td>';
                      $html .= '<td style="text-align:right">&nbsp;</td>';
                      $html .= '<td style="text-align:right">&nbsp;</td>';
          ...
          <tr> 
             <td colspan="4" align="right" class="tablecontent">&nbsp;</td>
             <td align="right" class="tablecontent-odd"><strong>'.currency_format($total).'</strong></td>
             <td align="right" class="tablecontent-odd"><strong>'.currency_format($totalTax).'</strong></td>';
          if ($penjualanTipe == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';           
          if ($penjualanOutlet == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';
          if ($penjualanPetugas == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';
          $html .='
          </tr>';
          $html .='
               
          <tr style="border-bottom-style:double"> 
             <td colspan="4" align="right" class="tablecontent">&nbsp;&nbsp;<strong>Total</strong></td>
             <td align="right" class="tablecontent-odd"><strong>&nbsp;</strong></td>
             <td align="right" class="tablecontent-odd"><strong>'.currency_format($total+$totalTax).'</strong></td>';
          if ($penjualanTipe == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';           
          if ($penjualanOutlet == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';
          if ($penjualanPetugas == "--") $html .='<td align="right" class="tablecontent-odd">&nbsp;</strong></td>';
          $html .='
