	...
	if($_POST["rol_id"])  $rolId = & $_POST["rol_id"];
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
		if($_POST["btnUpdate"]){
          ...
          if ($_POST["btnSave"]) 
               $sql = sprintf("SELECT rol_id FROM global_auth_role WHERE rol_name = '%s'",$_POST["rol_name"]);
          else
               $sql = sprintf("SELECT rol_id FROM global_auth_role WHERE rol_name = '%s' AND rol_id <> '%s'",$_POST["rol_name"],$_POST["rol_id"]);
...
<br>
<font color="purple"><strong>&nbsp;Hint&nbsp;:&nbsp;Field Required.</strong></font>
<? } ?>
