<?php
	...
	$sql = "select * from mp_paket where paket_member = 'n' and paket_jenis = 'M' order by paket_id";
	$rs = $dtaccess->Execute($sql,DB_SCHEMA);
	$dataPaketGuest = $dtaccess->FetchAll($rs);

	
	$sql = "select * from mp_paket where paket_member = 'y' and paket_jenis = 'M' order by paket_id";
	$rs = $dtaccess->Execute($sql,DB_SCHEMA);
