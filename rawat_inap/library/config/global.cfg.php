...
DEFINE("STATUS_INAP_PEMERIKSAAN","IM");
DEFINE("STATUS_INAP_PREOP","IP");
DEFINE("STATUS_INAP_OPERASI","IO");
DEFINE("STATUS_INAP_OPERASI_JADWAL","IJ");
DEFINE("STATUS_INAP_BEDAH","IB");
DEFINE("STATUS_INAP_DIAGNOSTIK","ID");
DEFINE("STATUS_INAP_SELESAI","IE");
DEFINE("STATUS_INAP_PREMEDIKASI","IK");
DEFINE("STATUS_RAWATINAP","I");
DEFINE("STATUS_INAP_CEKOUT","IC");
DEFINE("STATUS_INAP_MENINGGAL","IN");
DEFINE("STATUS_INAP_DOKTER","IV");
DEFINE("STATUS_INAP_ICU","IU");
DEFINE("STATUS_INAP_PICU","IL");
DEFINE("STATUS_INAP_APOTEK","IT");
DEFINE("STATUS_TINDAKAN_1","KA");
DEFINE("STATUS_TINDAKAN_2","KB");
DEFINE("STATUS_TINDAKAN_3","KC");
DEFINE("STATUS_TINDAKAN_VIP","KD");
...
$rawatStatus[STATUS_INAP_PEMERIKSAAN] = "Pemeriksaan";
$rawatStatus[STATUS_INAP_PREOP] = "PreOP";
$rawatStatus[STATUS_INAP_OPERASI] = "Operasi";
$rawatStatus[STATUS_INAP_OPERASI_JADWAL] = "Jadwal";
$rawatStatus[STATUS_INAP_BEDAH] = "Bedah Minor";
$rawatStatus[STATUS_INAP_DIAGNOSTIK] = "Diagnostik";
$rawatStatus[STATUS_INAP_SELESAI] = "Selesai";
$rawatStatus[STATUS_INAP_PREMEDIKASI] = "Premedikasi";
$rawatStatus[STATUS_RAWATINAP] = "Rawat Inap";
$rawatStatus[STATUS_INAP_CEKOUT] = "Check Out";
$rawatStatus[STATUS_INAP_MENINGGAL] = "Meninggal";
$rawatStatus[STATUS_INAP_ICU] = "ICU";
$rawatStatus[STATUS_INAP_PICU] = "PICU";
$rawatStatus[STATUS_INAP_APOTEK] = "Apotek";
$rawatStatus[STATUS_TINDAKAN_1] = "Kelas 1";
$rawatStatus[STATUS_TINDAKAN_2] = "Kelas 2";
$rawatStatus[STATUS_TINDAKAN_3] = "Kelas 3";
$rawatStatus[STATUS_TINDAKAN_VIP] = "Kelas VIP";

$biayaStatus[STATUS_REGISTRASI] = "Registrasi";
$biayaStatus[STATUS_REFRAKSI] = "Refraksi";
$biayaStatus[STATUS_INAP_PEMERIKSAAN] = "Pemeriksaan";
$biayaStatus[STATUS_INAP_PREOP] = "PreOP";
$biayaStatus[STATUS_INAP_OPERASI] = "Operasi";
$biayaStatus[STATUS_INAP_OPERASI_JADWAL] = "Jadwal";
$biayaStatus[STATUS_INAP_BEDAH] = "Bedah";
$biayaStatus[STATUS_INAP_DIAGNOSTIK] = "Diagnostik"; 
$biayaStatus[STATUS_INAP_PREMEDIKASI] = "Premedikasi";
$biayaStatus[STATUS_RAWATINAP] = "Rawat Inap";
$biayaStatus[STATUS_INAP_ICU] = "ICU";
$biayaStatus[STATUS_INAP_PICU] = "PICU";
$biayaStatus[STATUS_INAP_APOTEK] = "Apotek";
$biayaStatus[STATUS_MENINGGAL] = "Meninggal";
$biayaStatus[STATUS_MENINGGAL] = "Meninggal";
$biayaStatus[STATUS_TINDAKAN_1] = "Kelas 1";
$biayaStatus[STATUS_TINDAKAN_2] = "Kelas 2";
$biayaStatus[STATUS_TINDAKAN_3] = "Kelas 3";
$biayaStatus[STATUS_TINDAKAN_VIP] = "Kelas VIP";
...
DEFINE("TANPA_DIET","0");
DEFINE("DIET_DIABETES","1");
DEFINE("DIET_HIPERTENSI","2");
DEFINE("DIET_PURIN","3");
DEFINE("DIET_KOLESTEROL","4");

$dietPasien[TANPA_DIET] = "Tanpa Diet";
$dietPasien[DIET_DIABETES] = "Diabetes";
$dietPasien[DIET_HIPERTENSI] = "Hipertensi";
$dietPasien[DIET_PURIN] = "Rendah Purin";
$dietPasien[DIET_KOLESTEROL] = "Rendah Kolesterol";
