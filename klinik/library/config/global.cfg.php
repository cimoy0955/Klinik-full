...
// -- biaya pemeriksaan --
DEFINE("BIAYA_UJIMATA","OK1-16");
DEFINE("BIAYA_EPILASI","21");
DEFINE("BIAYA_PROBING","22");
DEFINE("BIAYA_SCHIMER","OK1-01");
DEFINE("BIAYA_FLUORECSIN","OK1-02");
DEFINE("BIAYA_ANEL","OPK1-32");
DEFINE("BIAYA_NCT","OK1-08");
DEFINE("BIAYA_FUNDUSCOPY","OK1-03");
...
// --- biaya injeksi ---
DEFINE("BIAYA_IM","IO1-03");
DEFINE("BIAYA_IV","IO1-06");
DEFINE("BIAYA_PRABULBER_SUBCONJUNCTIVA","IO1-09");
DEFINE("BIAYA_SUBCUTAN","IO1-12");
