...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" colspan=2 class="tableheader">CETAK REKAM MEDIK PASIEN</td>
	</tr>
</table> 
...
<legend><strong><u>Data Pasien</U></strong></legend>
	...
	<tr>
          <td colspan="3" align="center" class="tableheader">
               ...
               <?php echo $view->RenderButton(BTN_BUTTON,"btnUpdate","btnUpdate","Cetak Rekam Medik","button",false,'onClick="BukaWindow(\'rekmed_cetak.php?id_cust_usr='.$_POST["cust_usr_id"].'&id_reg='.$_POST["reg_id"].'\',\'Cetak Rekam Medik\')"',null);?>
