	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     if ($_GET["del"]) {
          $splitId = $enc->Decode($_GET["id"]);
           ...
           $sql = "delete from klinik.klinik_split where split_id = ".QuoteValue(DPE_CHAR,$splitId);
           $dtaccess->Execute($sql,DB_SCHEMA_GLOBAL);
    
    
          header("location:jenis_biaya_view.php");
          exit(); 
          }
...
<table width="100%" border="1" cellpadding="1" cellspacing="1">
    <tr class="tableheader">
        <td width="100%">&nbsp; Setup Jenis Biaya Rawat Jalan & UGD</td>
    </tr>
</table>
          ...
          <td align="right" width="10%">&nbsp;Layanan</td>
              <td width="35%">
                  <select name="split_flag">
    				...
    				<?php foreach($biayaTetap as $key=>$value) {?>
