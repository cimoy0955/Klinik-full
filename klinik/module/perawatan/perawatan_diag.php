<?php
	...
	if($_POST["id_reg"] && $_POST["id_cust_usr"]) {
		$sql = "select a.*
          ...
          $lokasiUsg = $ROOT."diagnostik/images/foto_usg";
     	$fotoUsg = $lokasiUsg."/".$dataDiagnostik["diag_gambar_usg"];
     
          $lokasiFundus = $ROOT."diagnostik/images/foto_fundus";
     	$fotoFundus = $lokasiFundus."/".$dataDiagnostik["diag_gambar_fundus"];
     
          $lokasiHumpre = $ROOT."diagnostik/images/foto_humpre";
     	$fotoHumpre = $lokasiHumpre."/".$dataDiagnostik["diag_gambar_humpre"];
     
          $lokasiOct = $ROOT."diagnostik/images/foto_oct";
...
<tr>
     ...
     <table width="100%" border="1" cellpadding="2" cellspacing="1">
          ...
          <tr>
               <td align="center" class="tablecontent">USG</td>
               <td align="center" class="tablecontent">Fundus</td>
          </tr>
          <tr>
          ...
          <tr>
               <td align="center" class="tablecontent">Humpreys</td>
               <td align="center" class="tablecontent">OCT</td>
          </tr>
	</table>
     </fieldset>
