<?php
	...
	if($_GET["id_reg"]) {
		...
		$_POST["rawat_keluhan"] = $dataPasien["ref_keluhan"];
          ...
          $sql = "select b.visus_nama as nk_od, d.visus_nama as k_od,a.ref_mata_od_koreksi_spheris,
a.ref_mata_od_koreksi_cylinder,a.ref_mata_od_koreksi_sudut, c.visus_nama as nk_os, 
e.visus_nama as k_os,a.ref_mata_os_koreksi_spheris,a.ref_mata_os_koreksi_cylinder,
a.ref_mata_os_koreksi_sudut 
...
left join klinik.klinik_visus b on b.visus_id=a.id_visus_nonkoreksi_od
              ...
              left join klinik.klinik_visus e on e.visus_id=a.id_visus_koreksi_os where a.id_reg = ".QuoteValue(DPE_CHAR,$_POST["id_reg"]);
...
-->     
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="center" class="tablecontent-odd" nowrap><?php echo $dataRefraksi["nk_od"];?></td>
               ...
               <td align="center" class="tablecontent-odd" nowrap><?php echo $dataRefraksi["k_od"];?></td>
          </tr>
          <tr>
               <td align="center" class="tablecontent">OS</td>
               <td align="center" class="tablecontent-odd" nowrap><?php echo $dataRefraksi["nk_os"];?></td>
               ...
               <td align="center" class="tablecontent-odd" nowrap><?php echo $dataRefraksi["k_os"];?></td>
          </tr>
	</table>
     </fieldset>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
           <tr>
               ...
               <td align="left" class="tablecontent-odd"><?php echo $view->RenderComboBox("rawat_keadaan_umum","rawat_keadaan_umum",$optionsKeadaan,null,null,null);?></td>
          </tr>
          <tr>
