<?php
     ...
     $sql_where[] = "cast(preop_waktu as date) >= ".QuoteValue(DPE_DATE,date_db($_POST["tgl_awal"]));
     $sql_where[] = "cast(preop_waktu as date) <= ".QuoteValue(DPE_DATE,date_db($_POST["tgl_akhir"]));

     $sql = "select cast(c.preop_tanggal_jadwal as date) as tanggal, b.cust_usr_kode, b.cust_usr_nama, b.cust_usr_alamat, 
                a.reg_jenis_pasien, a.reg_status_pasien
     ...
     $sql.= " order by c.preop_waktu, a.reg_status_pasien, b.cust_usr_nama";
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Keperluan";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "10%";   
     $tbHeader[0][$counterHeader][TABLE_COLSPAN] = "4";  
     $counterHeader++;
     
     $counterHeader=0;
     $tbHeader[1][$counterHeader][TABLE_ISI] = "TTV";
     $tbHeader[1][$counterHeader][TABLE_WIDTH] = "10%";     
     $counterHeader++;
     
     $tbHeader[1][$counterHeader][TABLE_ISI] = "Jadwal";
     $tbHeader[1][$counterHeader][TABLE_WIDTH] = "10%";     
     $counterHeader++;
     
     $tbHeader[1][$counterHeader][TABLE_ISI] = "PreOP";
     $tbHeader[1][$counterHeader][TABLE_WIDTH] = "10%";     
     $counterHeader++;
     
     $tbHeader[1][$counterHeader][TABLE_ISI] = "Operasi";
     $tbHeader[1][$counterHeader][TABLE_WIDTH] = "10%";     
     $counterHeader++;
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          ...
          $tbContent[$i][$counter][TABLE_ISI] = ($dataTable[$i]["tanggal"]) ? "<img src=\"".$ROOT."/images/check2.gif\" style=\"margin-left:44%\" />" : "&nbsp;";
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";          
          $counter++;
