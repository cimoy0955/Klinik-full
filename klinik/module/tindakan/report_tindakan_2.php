<?php
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Perawat";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "17%";     
     $counterHeader++;
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          ...
          $perawatnya = "";
          $query = "select b.pgw_nama 
                    from klinik.klinik_perawatan_operasi_suster_asisten a 
          ...
          $tbContent[$i][$counter][TABLE_ISI] = $perawatnya;
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";          
          $counter++;
