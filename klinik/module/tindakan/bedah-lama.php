...
*/
     ...
     if($_POST["btnSave"] || $_POST["btnUpdate"]) {
          ...
          if(!$_POST["bedah_regulasi_id"]) $_POST["bedah_regulasi_id"] = $dtaccess->GetTransID();
...
function isi(nama,id,kode){
    ...
    document.getElementById("op_jenis_kode").value = kode;
    document.getElementById("kotaksugest").style.visibility = "hidden";
    document.getElementById("kotaksugest").innerHTML = "";
}
...
-->
          ...
          <?php if(!$_POST["item_nama"]) { ?>
               <tr id="tr_terapi_0">
                    ...
                    <td align="center" class="tablecontent-odd">
                         <input class="button" name="btnAdd" id="btnAdd" type="button" value="Tambah" onClick="TambahObat();">
               ...
               <?php for($i=0,$n=count($_POST["id_item"]);$i<$n;$i++) { ?>
                    <tr id="tr_terapi_<?php echo $i;?>">
                         ...
                         <td align="left" class="tablecontent-odd" width="30%">
                              ...
                              <input class="button" name="btnAdd" id="btnAdd" type="button" value="Tambah" onClick="TambahObat();">
                              <?php } else { ?>
                              <input class="button" name="btnDel1[<?php echo $i;?>]" id="btnDel1_<?php echo $i;?>" type="button" value="Hapus" onClick="DeleteObat(<?php echo $i;?>);">
                              <?php } ?>
     ...
     <table width="100%" border="1" cellpadding="4" cellspacing="1">
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"> 
                    <?php
			  // echo $view->RenderComboBox("id_op_jenis","id_op_jenis",$optOperasiJenis,null,null,null);
			  echo $view->RenderTextBox("op_jenis_kode","op_jenis_kode","10","100",$_POST["op_jenis_kode"],"inputField", null,false,"onkeyup=\"lihat(this.value);\"");
			  ?>
			  <div id="kotaksugest" style="position:absolute; background-color:#FFCC99;width:400;visibility:hidden;z-index:100">
			  </div>
               </td>
		   <td align="left" class="tablecontent-odd" colspan="2">
			  <?php
			  echo $view->RenderTextBox("op_jenis_nama","op_jenis_nama","50","100",$_POST["op_jenis_nama"],"inputField", null,false);
			  echo $view->RenderHidden("id_op_jenis","id_op_jenis",$_POST["id_op_jenis"]);
			  ?>
		   </td>
          </tr>
          <!--<tr>
          ...
          <tr>
               ...
               <td align="left" class="tablecontent-odd"  colspan=3> 
                    <?php echo $view->RenderTextBox("op_metode","op_metode","50","100",$_POST["op_metode"],"inputField",null,false);?>               
               </td>
          </tr>
          <tr>
