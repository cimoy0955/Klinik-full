	...
	$page[STATUS_PREOP] = "preop.php";
     ...
     function GetTindakan($status) {
          ...
          $sql = "select cust_usr_nama,a.reg_id, a.reg_status, a.reg_waktu, a.reg_jadwal 
                    ...
                    where a.reg_status like '".STATUS_BEDAH.$status."' 
			  and a.reg_tipe_umur='D' order by reg_status desc, reg_tanggal asc, reg_waktu asc";
...
<!--
<div id="antri_main2" style="width:100%;height:auto;clear:both;overflow:auto">
	<div id="antri_kiri_bawah" style="float:left;width:49%;">
		<div class="tableheader">Operasi Kecil</div>
		<div id="antri_kiri_bawah_isi" style="height:100;overflow:auto"><?php echo GetTindakan(STATUS_ANTRI); ?></div>
	</div>
	
	<div id="antri_kanan_bawah" style="float:right;width:49%;">
		<div class="tableheader">Penjadwalan Operasi</div>
		<div id="antri_kanan_bawah_isi" style="height:100;overflow:auto"><?php echo GetTindakan(STATUS_PROSES); ?></div>
	</div>
</div>
-->
</form>
