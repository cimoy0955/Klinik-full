...
function GantiRegulasi() {
     if(document.getElementById('preop_regulasi').checked) {
          ...
          document.getElementById('tbDiag').style.display="none";
     } else {
...
function GantiBerhasil() {
     if(document.getElementById('preop_regulasi_berhasil').checked) {
          ...
          document.getElementById('tbDiag').style.display="inline-table";
...
<!--
     ...
     <div style="display:inline-block">
     	...
     	<table width="100%" border="1" cellpadding="4" cellspacing="1" id="tbDiag" style="display:none">
	  <tr>
	       <td colspan="4"><strong>Diagnostik</strong>&nbsp;<a href="#diag"  id="diag" onClick="selectAll();">Pilih Semua</a>/<a href="#diag" onClick="deselectAll();">Hilangkan Semua</a></td>
	  </tr>
        <tr>
               <td colspan="4">
