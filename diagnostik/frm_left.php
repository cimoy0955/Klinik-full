   ...
   if($_GET["panel"]) $panel = $_GET["panel"];
	...
	switch($panel){   
		...
		/*	$menu[$countMenu]["head"] = "Refraksi";
			...
			$menu[$countMenu]["head"] = "Jenis Pemeriksaan";
    ...
    // --- menu rawat inap ---
		...
		case "report":
			...
			*/
			...
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/diagnostik/report_pemeriksaan.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
			/*
			...
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/diagnostik/report_perawatan.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
	*/
			$menu[$countMenu]["head"] = "Rekap Diagnostik Harian";
			$menu[$countMenu]["priv"] = "report_diagnostik";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/diagnostik/report_diagnostik.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;

			$menu[$countMenu]["head"] = "Rekap Diagnostik Tahunan";
			$menu[$countMenu]["priv"] = "report_diagnostik";
			$menu[$countMenu]["href"] = $APLICATION_ROOT."module/diagnostik/rekap_diagnostik_tahunan.php";
			$menu[$countMenu]["status"] = true;        
			$countMenu++;
