<?php
	...
	if($_POST["cust_usr_id"]) {
     ...
     if($dataPasien) {
          ...
          $sql = "select a.diag_id, CAST(a.diag_waktu as date) as diag_tanggal from klinik.klinik_diagnostik a where a.id_cust_usr = ".QuoteValue(DPE_CHAR,$_POST["cust_usr_id"])." 
