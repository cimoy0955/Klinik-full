...
//		if ($in_month<10) $in_month = "0".$in_month;
	...
	function RenderBody($in_css,$isCal=false,$in_event=null,$isGrid=false,$in_cssPrint=null)
	{
     ...
     function InitSelect2()
     {
          ...
          $strBody = "<link href=\"//cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/css/select2.min.css\" rel=\"stylesheet\" />"."\n";
          $strBody .= "<script src=\"//cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/js/select2.min.js\"></script>";
          return $strBody;
     }
