<?php
     ...
     function GetFolio() {
          ...
          $sql = "select distinct a.id_reg, a.id_cust_usr, b.cust_usr_nama,a.fol_jenis,a.fol_waktu,id_biaya,a.fol_lunas, a.fol_id
                  ...
                  where a.fol_lunas = 'n'  and ( reg_ugd = 'n' or reg_status_ugd = 'n')
        ...
        if($_POST["btnSaveTambah"]){
            ...
            $skr = $_POST["waktunya"];
               ...
               $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["biaya_id_tambahan"]);
               ...
               $dbValue[9] = QuoteValue(DPE_NUMERIC,$_POST["txtJumlah"]);
      	...
      	$sql = "select * from klinik.klinik_biaya_split where id_biaya = ".QuoteValue(DPE_CHAR,$_POST["biaya_id_tambahan"]);
			...
			for($i=0,$n=count($dataSplit);$i<$n;$i++) {
				...
				$dbValue[1] = QuoteValue(DPE_CHAR,$folioId);
  ...
  //echo $sql;
    ...
    $_POST['fol_id'] = $_GET["fol_id"];
		...
		$sql = "select * from klinik.klinik_folio
			where id_reg = ".QuoteValue(DPE_CHAR,$_POST["id_reg"])." and fol_lunas = 'n' "; 
	//echo $sql;
...
//	$isprint = "n";
		...
		$dtaccess->Execute($sql);
		$sql = "update klinik.klinik_folio set fol_dibayar = fol_nominal, fol_lunas = 'y', fol_dibayar_when = CURRENT_TIMESTAMP where id_reg = ".QuoteValue(DPE_CHAR,$_POST["id_reg"]);
		//echo $sql;
    $dtaccess->Execute($sql);
...
<tr>
     ...
     <legend><strong>Tambah</strong></legend>
      <table width="100%" border="0" cellpadding="1" cellspacing="1">
               <tr>
                    <td align="left" width="20%" class="tablecontent">&nbsp;Tambahan&nbsp;</td>
