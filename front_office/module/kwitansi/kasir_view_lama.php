<?php
     ...
     function GetFolio() {
        ...
        if($fol[$data[$i]][$i]==STATUS_PEMERIKSAAN)
    			...
    			$tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'"><img hspace="2" width="25" height="25" src="'.$APLICATION_ROOT.'images/b_select.png" alt="Proses" title="Proses" border="0"/></a>';               
