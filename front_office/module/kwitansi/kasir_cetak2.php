...
<table width="500" border="0" cellpadding="4" cellspacing="1">
	<tr>
		<td align="left" valign="top" style="font-size:12px" width="37%" rowspan="10"><STRONG>RSUD "SOGATEN"</strong><br>JL. CAMPURSARI 12 MADIUN<br>
    Telp.0351-481314, 493113</td><td align="center" valign="top" style="font-size:12px" width="9%" rowspan="10">KWITANSI<br>No : <?php echo $_POST["kwitansi_nomor"];?></td></tr>
    <td align="left" valign="top" style="font-size:12px" width="19%">Tgl/jam<br>Nama<br>Alamat<br>Umur/kel.<br>No. Registrasi</td>
    <td align="left" valign="top" style="font-size:12px" width="35%">: <?php $tgl = getdateToday();
                           echo format_date_long($tgl);  ?><br>: <?php echo $dataPasien["cust_usr_nama"]; ?><br>:<br>: <?php echo $dataPasien["umur"]."/".$dataPasien["cust_usr_jenis_kelamin"]; ?><br>: <?php echo $dataPasien["cust_usr_kode"]; ?></td>
	</tr>
<tr>
...
<!--
<table width="475" border="1" cellpadding="3" cellspacing="1" class="tableisi">
