<?php
     ...
     function GetFolio() {
          global $dtaccess, $view, $tableRefraksi, $thisPage, $APLICATION_ROOT,$rawatStatus,$namaRegistrasi; 
          ...
          $sql = "select a.id_reg, a.id_cust_usr, b.cust_usr_nama,a.fol_jenis,a.fol_waktu,id_biaya,a.fol_lunas, a.fol_id
                  ...
                  where a.fol_lunas = 'n' and  (fol_jenis <> '".REGISTRASI_UGD."'
                  or fol_jenis <> '".REGISTRASI_VK."')
        ...
        if($fol[$data[$i]][$i]==STATUS_PEMERIKSAAN)
    			...
    			$tbContent[$i][$counter][TABLE_ISI] = $namaRegistrasi[$fol[$data[$i]][$i]];
    			$tbContent[$i][$counter][TABLE_ALIGN] = "left";
    			$counter++; 
            }
