<?php 
	...
	$sql = "select a.* from global.global_customer_user a  where a.cust_usr_id = ".QuoteValue(DPE_CHAR,$_POST["cust_usr_id"]);
...
<div id="dv_alamat"><?php echo nl2br(wordwrap($dataPasien["cust_usr_alamat"],35))."<BR>".$dataPasien["cust_usr_telp"];?></div>
