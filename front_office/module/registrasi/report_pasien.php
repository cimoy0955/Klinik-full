<?php
     ...
     $sql_where[] = "a.reg_tanggal = ".QuoteValue(DPE_DATE,date_db($_POST["tgl_awal"]));
          ...
          //nyari tipe rawat ee --
     if($_POST["tipe_rawat"]=="I" || $_POST["tipe_rawat"]=="D") $sql_where[] = "a.reg_tipe_rawat = ".QuoteValue(DPE_CHAR,$_POST["tipe_rawat"]);
     if($_POST["tipe_rawat"]=="n") $sql_where[] = "a.reg_tipe_rawat is null";
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
          ...
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";          
          $counter++;
          }elseif($dataTable[$i]["reg_tipe_rawat"]=="D") {
          $tbContent[$i][$counter][TABLE_ISI] = "Dinas Luar";
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";          
          $counter++;
          }
          else{
...
<table align="center" border=0 cellpadding=2 cellspacing=1 width="100%" class="tblForm" id="tblSearching">
     <tr>
          ...
          <td width="15%" class="tablecontent-odd">&nbsp;Status Bayar Pasien</td>
      ...
      <tr> 
     <td width="10%" class="tablecontent" align="left">Tipe Rawat</td>
     <td width="20%" class="tablecontent-odd">
     <select name="tipe_rawat" class="inputField" >
		 <option class="inputField" value="<?php if($_POST["tipe_rawat"]=="--") echo "selected";?>"><label>[Pilih Tipe]</label>&nbsp;
     <option class="inputField" name="tipe_rawat" id="tipe_rawat" value="I" <?php if($_POST["tipe_rawat"]=="I") echo "selected";?>><label>Rawat Inap</label>&nbsp;
     <option class="inputField" name="tipe_rawat" id="tipe_rawat" value="D" <?php if($_POST["tipe_rawat"]=="D") echo "selected";?>><label>Dinas Luar</label>&nbsp;
     <option class="inputField" name="tipe_rawat" id="tipe_rawat" value="n" <?php if($_POST["tipe_rawat"]=="n") echo "selected";?>><label>Rawat Jalan</label>&nbsp;
     </select>
    </td>
          <td width="15%" class="tablecontent-odd">&nbsp;</td>
          <td width="25%" class="tablecontent-odd">&nbsp;</td>
    </tr>
    <tr>
