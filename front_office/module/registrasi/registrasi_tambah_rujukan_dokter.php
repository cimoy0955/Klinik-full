     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {          
	  ...
	  if($_POST["rujukan_dokter_nama"]) $err_code = clearbit($err_code,1);
          ...
          if ($err_code == 0) {
               ...
               $dbField[4] = "rujukan_dokter_nomor_rekening";
               ...
               $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["rujukan_dokter_nomor_rekening"]);
...
<tr>
     ...
     <table width="100%" cellpadding="1" cellspacing="1">
	  ...
	  <tr>
       ...
       <tr>
            <td align="right" class="tablecontent" width="30%"><strong>No. Rekening</td>
            <td width="70%">
              <?php echo $view->RenderTextBox("rujukan_dokter_nomor_rekening","rujukan_dokter_nomor_rekening","50","255",$_POST["rujukan_dokter_nomor_rekening"],"inputField", null,false);?>
            </td>
       </tr>
