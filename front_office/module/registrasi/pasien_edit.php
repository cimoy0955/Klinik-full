<?php
     ...
     function CheckKode($kode,$custUsrId=null)
	{
     ...
     if ($_GET["id"]) {
		...
		$sql = "select a.*,b.cust_nama from global.global_customer_user a left join global.global_customer b on a.id_cust = b.cust_id where a.cust_usr_id = ".QuoteValue(DPE_CHAR,$userCustId);
    //echo $sql;
